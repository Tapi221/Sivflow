      ...
      getConfig: () => [
        {
          label: 'Open Sivflow',
          click: () => {
            logger.info('User action: Open Sivflow');
            getMainWindow()
              .then(w => {
                w.show();
              })
              .catch(err => {
                logger.error('Failed to open Sivflow:', err);
              });
          },
        },
        {
        ...
        'separator',
        {
          label: 'Quit Sivflow Completely...',
          click: () => {
            logger.info('User action: Quit Sivflow Completely');
            app.quit();
          },
        },
      ],
