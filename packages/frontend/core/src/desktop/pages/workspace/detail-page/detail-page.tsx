...
import { EditorTagPanel } from './tabs/tag';
...
const DetailPageImpl = memo(function DetailPageImpl() {
  ...
  return (
    <FrameworkScope scope={editor.scope}>
      ...
      <ViewSidebarTab tabId="properties" icon={<InformationIcon />}>
      ...
      <ViewSidebarTab tabId="tag" icon={<TagIcon />}>
        <Scrollable.Root className={styles.sidebarScrollArea}>
          <Scrollable.Viewport>
            <EditorTagPanel docId={doc.id} />
          </Scrollable.Viewport>
          <Scrollable.Scrollbar />
        </Scrollable.Root>
      </ViewSidebarTab>
