...
import { LockIcon, MailIcon, MailWarningIcon, UnlockIcon } from 'lucide-react';
import {
  type Dispatch,
  type ReactNode,
  type SetStateAction,
            ...
            <div className="flex flex-col gap-2 text-xs max-md:hidden">
              ...
              <div className="flex gap-3 items-center justify-start">
                <StatusItem
                  ...
                  IconFalse={
                    <UnlockIcon size={16} className="text-destructive" />
                  }
                ...
                <StatusItem
                  ...
                  IconFalse={
                    <MailWarningIcon size={16} className="text-destructive" />
                  }
