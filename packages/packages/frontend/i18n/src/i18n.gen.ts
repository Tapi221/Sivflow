...
export function useAFFiNEI18N(): {
    ...
    Enable(): string;
    /**
      * `Enable Sivflow Cloud`
      */
    ["Enable Sivflow Cloud"](): string;
    /**
      * `If enabled, the data in this workspace will be backed up and synchronised via Sivflow Cloud.`
      */
    ["Enable Sivflow Cloud Description"](): string;
    /**
      * `The following functions rely on Sivflow Cloud. All data is stored on the current device. You can enable Sivflow Cloud for this workspace to keep data in sync with the cloud.`
      */
    ...
    Sync(): string;
    /**
      * `Synced with Sivflow Cloud`
      */
    ["Synced with Sivflow Cloud"](): string;
    /**
      * `Tags`
      */
    Tags(): string;
    ...
    /**
      ...
      */
    ["com.affine.aboutSivflow.autoCheckUpdate.description"](): string;
    /**
      * `Check for updates automatically`
      */
    ["com.affine.aboutSivflow.autoCheckUpdate.title"](): string;
    /**
      * `Automatically download updates (to this device).`
      */
    ["com.affine.aboutSivflow.autoDownloadUpdate.description"](): string;
    /**
      * `Download updates automatically`
      */
    ["com.affine.aboutSivflow.autoDownloadUpdate.title"](): string;
    /**
      * `View the Sivflow Changelog.`
      */
    ["com.affine.aboutSivflow.changelog.description"](): string;
    /**
      * `Discover what's new`
      */
    ["com.affine.aboutSivflow.changelog.title"](): string;
    /**
      * `Check for update`
      */
    ["com.affine.aboutSivflow.checkUpdate.button.check"](): string;
    /**
      * `Download update`
      */
    ["com.affine.aboutSivflow.checkUpdate.button.download"](): string;
    /**
      * `Restart to update`
      */
    ["com.affine.aboutSivflow.checkUpdate.button.restart"](): string;
    /**
      * `Retry`
      */
    ["com.affine.aboutSivflow.checkUpdate.button.retry"](): string;
    /**
      * `New version is ready`
      */
    ["com.affine.aboutSivflow.checkUpdate.description"](): string;
    /**
      * `Manually check for updates.`
      */
    ["com.affine.aboutSivflow.checkUpdate.subtitle.check"](): string;
    /**
      * `Checking for updates...`
      */
    ["com.affine.aboutSivflow.checkUpdate.subtitle.checking"](): string;
    /**
      * `Downloading the latest version...`
      */
    ["com.affine.aboutSivflow.checkUpdate.subtitle.downloading"](): string;
    /**
      * `Unable to connect to the update server.`
      */
    ["com.affine.aboutSivflow.checkUpdate.subtitle.error"](): string;
    /**
      * `You've got the latest version of Sivflow.`
      */
    ["com.affine.aboutSivflow.checkUpdate.subtitle.latest"](): string;
    /**
      * `Restart to apply update.`
      */
    ["com.affine.aboutSivflow.checkUpdate.subtitle.restart"](): string;
    /**
      * `New update available ({{version}})`
      */
    ["com.affine.aboutSivflow.checkUpdate.subtitle.update-available"](options: {
        readonly version: string;
    }): string;
    /**
      * `Check for updates`
      */
    ["com.affine.aboutSivflow.checkUpdate.title"](): string;
    /**
      * `Communities`
      */
    ["com.affine.aboutSivflow.community.title"](): string;
    /**
      * `Sivflow community`
      */
    ["com.affine.aboutSivflow.contact.community"](): string;
    /**
      * `Contact us`
      */
    ["com.affine.aboutSivflow.contact.title"](): string;
    /**
      * `Official website`
      */
    ["com.affine.aboutSivflow.contact.website"](): string;
    /**
      * `Privacy`
      */
    ["com.affine.aboutSivflow.legal.privacy"](): string;
    /**
      * `Legal Info`
      */
    ["com.affine.aboutSivflow.legal.title"](): string;
    /**
      * `Terms of use`
      */
    ["com.affine.aboutSivflow.legal.tos"](): string;
    /**
      * `Information about Sivflow`
      */
    ["com.affine.aboutSivflow.subtitle"](): string;
    /**
      * `About Sivflow`
      */
    ["com.affine.aboutSivflow.title"](): string;
    /**
      * `App version`
      */
    ["com.affine.aboutSivflow.version.app"](): string;
    /**
      * `Editor version`
      */
    ["com.affine.aboutSivflow.version.editor.title"](): string;
    /**
      * `Version`
      */
    ["com.affine.aboutSivflow.version.title"](): string;
    /**
      * `Get started`
      */
    ...
    /**
      * `Answer questions, draft docs, visualize ideas - Sivflow AI can save you time at every possible step. Powered by GPT's most powerful model.`
      */
    ["com.affine.ai-onboarding.general.2.description"](): string;
    /**
      * `Chat with Sivflow AI`
      */
    ...
    /**
      * `To use Sivflow AI, please sign in to your Sivflow Cloud account.`
      */
    ...
    /**
      * `Accent Color`
      */
    ["com.affine.appearanceSettings.accentColor.title"](): string;
    /**
     * @default "Second Accent Color"
     */
    ["com.affine.appearanceSettings.secondAccentColor.title"](): string;
    /**
      * `Customize the accent color of the client`
      */
    ["com.affine.appearanceSettings.accentColor.description"](): string;
    /**
     * @default "Customize the second accent color of the client"
     */
    ["com.affine.appearanceSettings.secondAccentColor.description"](): string;
    /**
      * `Edit all Sivflow theme variables here`
      */
    ...
    /**
      * `Document`
      */
    ["com.affine.appearanceSettings.document.title"](): string;
    /**
      * `Show Info Section`
      */
    ["com.affine.appearanceSettings.displayInfoSection.title"](): string;
    /**
      * `Toggle the display of the information section such as page properties`
      */
    ["com.affine.appearanceSettings.displayInfoSection.description"](): string;
    /**
      * `Mono`
      */
    ...
    /**
      * `Customize your Sivflow appearance`
      */
    ...
    /**
      * `Display the menubar app in the tray for quick access to Sivflow or meeting recordings.`
      */
    ...
    /**
      * `Open Sivflow when left‑clicking the tray icon.`
      */
    ...
    /**
      * `Minimize Sivflow to the system tray.`
      */
    ...
    /**
      * `Close Sivflow to the system tray.`
      */
    ...
    /**
      * `Start Sivflow minimized to the system tray.`
      */
    ...
    /**
      * `Congratulations! You have successfully updated the email address associated with your Sivflow Cloud account.`
      */
    ...
    /**
      * `Requires Sivflow desktop app version 0.18 or later.`
      */
    ...
    /**
      * `Welcome to Sivflow Cloud, you are almost there!`
      */
    ...
    /**
      * `Reset your Sivflow Cloud password`
      */
    ...
    /**
      * `Your password has been updated! You can sign in Sivflow Cloud with new password!`
      */
    ...
    /**
      * `Your password has saved! You can sign in Sivflow Cloud with email and password!`
      */
    ...
    /**
      * `Set your Sivflow Cloud password`
      */
    ...
    /**
      * `The app will automatically open or redirect to the web version. If you encounter any issues, you can also click the button below to manually open the Sivflow app.`
      */
    ...
    /**
      * `You have successfully signed in. The app will automatically open or redirect to the web version. if you encounter any issues, you can also click the button below to  manually open the Sivflow app.`
      */
    ...
    /**
      * `You have been signed in, start to sync your data with Sivflow Cloud!`
      */
    ...
    /**
      * `Host by Sivflow.Pro, Save, sync, and backup all your data.`
      */
    ...
    /**
      * `The current workspace is a local workspace, and we do not support version history for it at the moment. You can enable Sivflow Cloud. This will sync the workspace with the Cloud, allowing you to use this feature.`
      */
    ["com.affine.history-vision.tips-modal.description"](): string;
    /**
      * `History vision needs Sivflow Cloud`
      */
    ...
    /**
      * `Import your Bear note backup. Tags will be converted to Sivflow tags and folders.`
      */
    ...
    /**
      * `Import your Sivflow workspace and page snapshot file.`
      */
    ...
    /**
      * `Import your Sivflow db file (.affine)`
      */
    ...
    /**
      * `Your document has been imported successfully, thank you for choosing Sivflow. Any questions please feel free to feedback to us`
      */
    ...
    /**
      * `Start Sivflow without an account`
      */
    ...
    /**
      * `Enabling Sivflow Cloud allows you to synchronise and backup data, as well as support multi-user collaboration and content publishing.`
      */
    ["com.affine.nameWorkspace.affine-cloud.description"](): string;
    /**
      * `Sync across devices with Sivflow Cloud`
      */
    ...
    /**
      * `Enter a link to websites or Sivflow docs. Useful for connecting to external resources and referencing internal docs.`
      */
    ...
    /**
      * `Congratulations on your successful purchase of Sivflow AI! You're now empowered to refine your content, generate images, and craft comprehensive mindmaps directly within Sivflow AI, dramatically enhancing your productivity.`
      */
    ...
    /**
      * `If you end your subscription now, you can still use Sivflow AI until the end of this billing period.`
      */
    ...
    /**
      * `Are you sure you want to resume the subscription for Sivflow AI? This means your payment method will be charged automatically at the end of each billing cycle, starting from the next billing cycle.`
      */
    ...
    /**
      * `You have purchased Sivflow AI. The expiration date is {{end}}.`
      */
    ["com.affine.payment.ai.billing-tip.end-at"](options: {
        readonly end: string;
    }): string;
    /**
      * `You have purchased Sivflow AI. The next payment date is {{due}}.`
      */
    ...
    /**
      * `Please tell us more about your use case, to make Sivflow better.`
      */
    ...
    /**
      * `Everything in Sivflow FOSS & Basic.`
      */
    ...
    /**
      * `We'd like to hear more about where we fall short, so that we can make Sivflow better.`
      */
    ...
    /**
      * `Dedicated Discord support with Sivflow makers`
      */
    ...
    /**
      * `Upgrade to Sivflow Pro for expanded member capacity`
      */
    ...
    /**
      * `You can still use Sivflow Cloud Pro until the end of this billing period :)`
      */
    ["com.affine.payment.modal.downgrade.caption"](): string;
    /**
      * `Keep Sivflow Cloud Pro`
      */
    ...
    /**
      * `This is the pricing plans of Sivflow Cloud. You can sign up or sign in to your account first.`
      */
    ...
    /**
      * `We'd like to hear more about your use case, so that we can make Sivflow better.`
      */
    ...
    /**
      * `Congratulations! Your Sivflow account has been successfully upgraded to a Pro account.`
      */
    ...
    /**
      * `Thank you for purchasing the Sivflow self-hosted license.`
      */
    ...
    /**
      * `Doc analytics over 7 days require an Sivflow Team subscription.`
      */
    ...
    /**
      * `Add existing pages`
      */
    ["com.affine.rootAppSidebar.organize.folder.add-existing-pages"](): string;
    /**
      * `Add PDFs`
      */
    ["com.affine.rootAppSidebar.organize.folder.add-pdfs"](): string;
    /**
      * `New doc`
      */
    ...
    /**
      * `File not found`
      */
    ["com.affine.rootAppSidebar.organize.folder.file-not-found"](): string;
    /**
      * `You can only upload files less than {{size}}`
      */
    ["com.affine.rootAppSidebar.organize.folder.file-too-large"](options: {
    ...
    /**
      * `Enable the powerful AI assistant, Sivflow AI.`
      */
    ...
    /**
      * `Change the font size of the note title.`
      */
    ["com.affine.settings.editorSettings.general.title-font-size.description"](): string;
    /**
      * `Title Font Size`
      */
    ["com.affine.settings.editorSettings.general.title-font-size.title"](): string;
    /**
    ...
    /**
      * `Enable Sivflow Cloud to collaborate with others`
      */
    ...
    /**
      * `Sivflow will generate meeting notes by recording your meetings. Authorization to "Screen & System Audio Recording" is necessary.`
      */
    ...
    /**
      * `Use workspace provider keys before Sivflow AI plan routes.`
      */
    ...
    /**
      * `Upgrade this workspace to add provider keys and route Sivflow AI through your own OpenAI, Anthropic, Gemini, or FAL account.`
      */
    ...
    /**
      * `Local keys on this device are tried first. Workspace server keys follow, then Sivflow AI plan routes when quota is available.`
      */
    ...
    /**
      * `Transcript and workspace indexing require a server Gemini BYOK key or Sivflow AI plan fallback.`
      */
    ["com.affine.settings.workspace.byok.warning.transcript"](): string;
    /**
      * `Workspace indexing requires a server Gemini BYOK key or Sivflow AI plan fallback.`
      */
    ...
    /**
      * `Meetings allows you to record and transcribe meetings. Don't forget to enable it in Sivflow settings.`
      */
    ...
    /**
      * `Enable Sivflow Cloud to publish this workspace`
      */
    ...
    /**
      * `Allow Sivflow AI Assistant`
      */
    ["com.affine.settings.workspace.affine-ai.label"](): string;
    /**
      * `Allow workspace members to use Sivflow AI features. This setting doesn't affect billing. Workspace members use Sivflow AI through their personal accounts.`
      */
    ...
    /**
      * `Manage Sivflow indexing and Sivflow AI Embedding for local content processing`
      */
    ...
    /**
      * `Sharing doc requires Sivflow Cloud.`
      */
    ...
    /**
      * `Empower your sharing with Sivflow Cloud: One-click doc sharing`
      */
    ...
    /**
      * `No parent`
      */
    ["com.affine.tags.create-tag.no-parent"](): string;
    /**
      * `Tag already exists`
      */
    ...
    /**
      * `To ensure compatibility with the updated Sivflow client, please upgrade your data by clicking the "Upgrade workspace data" button below.`
      */
    ...
    /**
      * `Import web pages to Sivflow`
      */
    ["com.affine.integration.web-clipper.desc"](): string;
    /**
      * `Elevate your Sivflow experience with diverse add-ons and seamless integrations.`
      */
    ["com.affine.integration.setting.description"](): string;
    /**
      * `Learn how to develop a integration for Sivflow`
      */
    ...
    /**
      * `Manually import your content to Sivflow from Readwise`
      */
    ...
    /**
      * `Once disconnected, content will no longer be imported. Do you want to keep your existing highlights in Sivflow?`
      */
    ...
    /**
      * `New Readwise highlights will be imported to Sivflow `
      */
    ["com.affine.integration.readwise.setting.sync-new-name"](): string;
    /**
      * `New highlights in Readwise will be synced to Sivflow `
      */
    ...
    /**
      * `New events will be scheduled in Sivflow’s journal`
      */
    ...
    /**
      * `Enabling this setting allows you to connect your calendar events to your Journal in Sivflow`
      */
    ...
    /**
      * `Enable other MCP Client to search and read the doc of Sivflow.`
      */
...
export const TypedTrans: {
    /**
      * `Go to <a>{{link}}</a> for learn more details about Sivflow AI.`
      */
    ...
    /**
      * `The Self-Hosted instance is not hosted or deployed by Sivflow. Your data will be stored on these instances.  <1>Learn more about Self-Host details.</1>`
      */
    ["com.affine.auth.sign.add-selfhosted.description"]: ComponentType<TypedTransProps<Readonly<{}>, {
        ["1"]: JSX.Element;
    }>>;
    /**
      * `By clicking “Continue with Google/Email” above, you acknowledge that you agree to Sivflow's <1>Terms of Conditions</1> and <3>Privacy Policy</3>.`
      */
    ...
    /**
      * `This demo is limited. <1>Download the Sivflow Client</1> for the latest features and Performance.`
      */
    ...
    /**
      * `Utilize the meeting notes and AI summarization features provided by Sivflow. <1>Discuss more in the community</1>.`
      */
    ...
    /**
      * `Import your Readwise highlights to Sivflow. Please visit Readwise, <br />click <a>"Get Access Token"</a>, and paste the token below.`
      */
