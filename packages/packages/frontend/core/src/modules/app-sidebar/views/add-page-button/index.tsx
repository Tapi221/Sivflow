import { IconButton, Menu, MenuItem, MenuSub } from '@affine/component';
...
function AddPageWithAsk({ className, style, variant }: AddPageButtonProps) {
  const t = useI18n();
  ...
  return (
    ...
    >
      <IconButton
        ...
        style={style}
        variant={variant === 'plain' ? 'plain' : 'solid'}
        size={16}
      >
        <PlusIcon />
      </IconButton>
...
function AddPageWithoutAsk({ className, style, variant }: AddPageButtonProps) {
  const createDoc = useNewDoc();
