...
import type { ButtonClickPanelCodeLanguageItem } from "@web-renderer/chip/panel/buttonclickpanel.desktop/ButtonClickPanel.CodeLanguage";
import { ButtonClickPanelCodeLanguage } from "@web-renderer/chip/panel/buttonclickpanel.desktop/ButtonClickPanel.CodeLanguage";
...
const CodeBlockCombobox = () => {
  ...
  const handleLanguageSelect = React.useCallback(
    (languageValue: string) => {
      editor.tf.setNodes<TCodeBlockElement>({ lang: languageValue }, { at: element });
      setSearchValue(languageValue);
      setOpen(false);
    },
    [editor, element],
  );
...
const CodeBlockElement = (props: PlateElementProps<TCodeBlockElement>) => {
  ...
  return (
    <PlateElement className={CODE_BLOCK_ELEMENT_CLASS_NAME} {...props}>
