...
import { RIGHT_CLICK_PANEL_MARGIN, RIGHT_CLICK_PANEL_SURFACE_PADDING } from "@web-renderer/chip/panel/rightClickPanel.utils";
...
const LAYERED_COLOR_MENU_OPTIONS: readonly LayeredColorMenuOption[] = TAG_COLOR_KEYS.map((colorKey) => ({ id: colorKey, label: TAG_COLOR_LABELS[colorKey], value: TAG_COLOR_PALETTE[colorKey].swatch }));
...
const LAYERED_COLOR_MENU_WIDTH = Math.ceil(LAYERED_COLOR_MENU_GRID_WIDTH + RIGHT_CLICK_PANEL_SURFACE_PADDING * 2);
const LAYERED_COLOR_MENU_HEIGHT = Math.ceil(LAYERED_COLOR_MENU_GRID_HEIGHT + RIGHT_CLICK_PANEL_SURFACE_PADDING * 2);
