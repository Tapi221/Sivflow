...
import { getTagColorSwatchStyle } from "@web-renderer/chip/budge/tag/tagColor";
...
import { resolveRightClickPanelTextWidth, RIGHT_CLICK_PANEL_MARGIN, RIGHT_CLICK_PANEL_SURFACE_PADDING } from "@web-renderer/chip/panel/rightClickPanel.utils";
...
const TAG_COLOR_GRID_WIDTH = TAG_COLOR_GRID_COLUMNS * TAG_COLOR_SWATCH_SIZE + (TAG_COLOR_GRID_COLUMNS - 1) * TAG_COLOR_GRID_GAP + TAG_COLOR_GRID_HORIZONTAL_PADDING * 2;
const TAG_COLOR_CONTEXT_MENU_WIDTH = Math.ceil(Math.max(resolveRightClickPanelTextWidth([TAG_COLOR_CONTEXT_MENU_TITLE]), TAG_COLOR_GRID_WIDTH + RIGHT_CLICK_PANEL_SURFACE_PADDING * 2));
const TAG_COLOR_CONTEXT_MENU_HEIGHT = 92;
const TAG_COLOR_CONTEXT_MENU_MARGIN = RIGHT_CLICK_PANEL_MARGIN;
            ...
            return (
              <button
                ...
                className={cn(
                  ...
                  isSelected && "ring-2 ring-primary-500/35 ring-offset-1 ring-offset-white",
                )}
