...
import { Calendar, FileText, Folder, Image, Layers, List, MessageSquare, Search, SearchX, Settings2, Tag, Trash2, X } from "@web-renderer/chip/icons/icons";
import { Dialog, DialogContent } from "@web-renderer/chip/panel/dialog.desktop/dialog/dialog";
import { Command, CommandItem, CommandList } from "@web-renderer/chip/ui/command";
