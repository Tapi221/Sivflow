...
test.skip('should forbid magic link with external callbackUrl', async t => {
  const { app } = t.context;
...
test.skip('should forbid magic link with untrusted redirect_uri in callbackUrl', async t => {
  const { app } = t.context;
...
test.skip('should be able to sign out', async t => {
  const { app } = t.context;
...
test.skip('should reject cookie sign out when csrf header is missing', async t => {
  const { app } = t.context;
...
test.skip('should be able to sign out with jwt without csrf', async t => {
  const { app } = t.context;
...
test.skip('should ignore user_id query when signing out with jwt', async t => {
  const { app } = t.context;
...
test.skip('should reuse jwt session when signing in another account without cookies', async t => {
  const { app } = t.context;
...
test.skip('should not reuse legacy bearer session id when signing in another account without cookies', async t => {
  const { app } = t.context;
...
test.skip('should be able to sign out when duplicated csrf cookies exist', async t => {
  const { app } = t.context;
...
test.skip('should reject sign out when csrf token mismatched', async t => {
  const { app } = t.context;
...
test.skip('should sign in desktop app via one-time open-app code', async t => {
  const { app } = t.context;
