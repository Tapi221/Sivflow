...
describe("useCalendarEventMoveController", () => {
  ...
  it("moves the event, shows a success toast, and undoes through Google Calendar update", async () => {
  ...
  it("keeps a rollback override and shows an error toast when moving fails", async () => {
