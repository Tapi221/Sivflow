...
export const SidebarToggleIcon = ({ className, ...props }: SidebarIconProps) => (
  <IconShell className={className} {...props}>
    ...
    <path d="M9.5 4.5V19.5" stroke="currentColor" strokeWidth="1.7" strokeLinecap="round" />
  </IconShell>
);

export const HomeIcon = ({ className, ...props }: SidebarIconProps) => (
  <IconShell className={className} {...props}>
    <path d="M20 8.5V13.5C20 17.271 20 19.157 18.828 20.328C17.656 21.499 15.771 21.5 12 21.5C8.229 21.5 6.343 21.5 5.172 20.328C4.001 19.156 4 17.271 4 13.5V8.5" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" />
    <path d="M22 10.5L17.657 6.335C14.99 3.778 13.657 2.5 12 2.5C10.343 2.5 9.01 3.778 6.343 6.335L2 10.5" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" />
  </IconShell>
);
...
export const CalendarIcon = ({ className, ...props }: SidebarIconProps) => (
  <IconShell className={className} {...props}>
    <path d="M18 2V4M6 2V4M10 17V13.347C10 13.156 9.863 13 9.695 13H9M13.63 17L14.984 13.35C15.047 13.179 14.913 13 14.721 13H13" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
