        ...
        >
          ...
          {showCloseButton ? (
            <DialogPrimitive.Close
              className={cn(
                "ds-dialog__close absolute right-4 top-4 rounded-sm opacity-70 focus:outline-none disabled:pointer-events-none data-[state=open]:bg-[var(--ds-color-neutral-50)]",
                closeButtonClassName,
              )}
            >
              <X className="h-4 w-4" />
