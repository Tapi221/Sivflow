...
export const voidRemoveSuggestionVariants = cva("", { defaultVariants: { active: false }, variants: { active: { false: "", true: voidRemoveSuggestionClass } } });

export const isStaticVoidRemoveSuggestion = (element: TElement) => { return ((element as TElement & { suggestion?: { type?: string; }; }).suggestion?.type === "remove");
};

export const VoidRemoveSuggestionOverlayStatic = ({ editor, element }: { editor: any;
  element: TElement;
}) => {
  const active =
...
export const SuggestionLeafStatic = (props: SlateLeafProps<TSuggestionText>) => { const { editor, leaf } = props;
