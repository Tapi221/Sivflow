...
export function VoidRemoveSuggestionOverlayStatic({ editor, element }: { editor: any;
  element: TElement;
}) {
  const active =
...
export function SuggestionLeafStatic(props: SlateLeafProps<TSuggestionText>) { const { editor, leaf } = props;
