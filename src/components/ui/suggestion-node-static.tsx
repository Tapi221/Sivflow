...
const isStaticVoidRemoveSuggestion = (element: TElement) => { return ((element as TElement & { suggestion?: { type?: string; }; }).suggestion?.type === "remove");
};
...
const SuggestionLeafStatic = (props: SlateLeafProps<TSuggestionText>) => { const { editor, leaf } = props;
