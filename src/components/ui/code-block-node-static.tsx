 ...
 */
const CodeBlockElementDocx = (props: SlateElementProps<TCodeBlockElement>) => {
  return (<SlateElement {...props}> <div style={{ backgroundColor: "#f5f5f5", border: "1px solid #e0e0e0", margin: "8pt 0", padding: "12pt" }} > {props.children} </div> </SlateElement>);
};
const CodeLineElementDocx = (props: SlateElementProps) => {
  return (<SlateElement {...props} as="p" style={{ fontFamily: "'Courier New', Consolas, monospace", fontSize: "10pt", margin: 0, padding: 0 }} />);
};
