    ...
    return (
      <div className="space-y-1 mt-1">
        {sortedFolderIds.map((folderId) => {
          ...
          const folderName =
            folder?.folderName || folder?.folder_name || "未分類";
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Badge
          variant="secondary"
          className="h-5 px-1.5 text-[10px] font-bold bg-slate-100 text-slate-500 shadow-none border-none"
        >
          {studiedCount}/{total}
        </Badge>
      </div>
              ...
              <div key={card.id}>
                ...
                >
                  <span className="truncate">
                    {card.title || card.question_text?.substring(0, 20)}
                  </span>
                  {isStudied && (
