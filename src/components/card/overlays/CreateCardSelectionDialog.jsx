 ...
 */
export default function CreateCardSelectionDialog({ open, onOpenChange, onSelectMode }) {
  return (
      ...
      <DialogContent className="sm:max-w-md">
        ...
        <div className="grid grid-cols-1 gap-4 py-4">
          ...
          >
            ...
            <div>
              <h3 className="font-bold text-slate-800 group-hover:text-primary-700">モード連続作成</h3>
              <p className="text-sm text-slate-500">一問一答や4択など、形式を選んで連続で作成します</p>
            </div>
          </button>
          ...
          >
            ...
            <div>
              ...
              <p className="text-sm text-slate-500">基本のエディタを使って1枚ずつ丁寧に作成します</p>
            </div>
          </button>
        </div>
