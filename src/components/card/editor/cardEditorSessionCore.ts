...
export const cloneAttachments = (attachments: CardFaceAttachments | null | undefined): CardFaceAttachments => {
...
export const sanitizeAttachmentsForSave = (attachments: CardFaceAttachments | null | undefined): CardFaceAttachments => {
...
export const hasMeaningfulAttachments = (attachments: CardFaceAttachments | null | undefined) => {
...
export const buildDraftFromCard = (card: Card, tagById: TagNameLookup): EditorDraft => {
  const legacyQuestionRows = normalizeExtraRows((card as unknown as {
...
export const buildPatchFromDraft = (draft: EditorDraft): CardPatch => {
...
export const prepareDraftForPersist = async (draft: EditorDraft): Promise<EditorDraft> => {
  return waitForDraftImageUploads(draft);
};
export const buildSavePayload = async ({ draft, addTag }: BuildSavePayloadParams): Promise<CardPatch> => {
...
export const buildCardPatchForToggle = (card: Card, field: CardToggleField): CardPatch => {
  return { [field]: !card[field] } as CardPatch;
};
export const createPanelCard = ({ selectedCard, draft, isEditing }: CreatePanelCardParams): Card | null => {
