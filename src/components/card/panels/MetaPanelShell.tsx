      ...
      style={
        {
          ...
          "--meta-panel-surface-elevated":
            "color-mix(in srgb, var(--ds-semantic-color-background-app) 78%, var(--ds-semantic-color-background-sidebar) 22%)",
          "--meta-panel-border":
            "color-mix(in srgb, var(--ds-semantic-color-border-default) 76%, #d8c7b7 24%)",
          "--meta-panel-border-strong":
            "color-mix(in srgb, var(--ds-semantic-color-border-strong) 58%, #d8c7b7 42%)",
          "--meta-panel-text-muted":
            "color-mix(in srgb, var(--sidebar-text-muted, var(--ds-semantic-color-text-secondary)) 90%, var(--ds-semantic-color-text-primary) 10%)",
          "--meta-panel-accent":
            "color-mix(in srgb, #0f766e 82%, var(--ds-semantic-color-action-primary) 18%)",
          "--meta-panel-accent-soft":
            "color-mix(in srgb, var(--meta-panel-accent) 12%, white 88%)",
          "--meta-panel-shadow-soft":
            "inset 0 1px 0 rgba(255, 255, 255, 0.72), 0 1px 2px rgba(86, 72, 74, 0.12)",
          "--meta-panel-shadow-strong":
            "0 8px 24px rgba(15, 23, 42, 0.08), inset 0 1px 0 rgba(255, 255, 255, 0.88)",
