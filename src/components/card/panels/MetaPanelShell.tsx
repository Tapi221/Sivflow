...
export const MetaPanelShell = ({ children, className, bodyClassName, contentClassName, style }: MetaPanelShellProps) => {
...
export const MetaPanelLeadSection = ({ children, className }: MetaPanelLeadSectionProps) => {
