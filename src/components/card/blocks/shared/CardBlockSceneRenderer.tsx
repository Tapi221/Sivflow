...
import { PdfBlockContent } from "@/components/card/blocks/pdf/PdfBlockContent";
...
import { Code, FileText, HelpCircle, Link, NotebookPen, Sigma, Type, Volume2 } from "@/ui/icons";
import { cn } from "@/lib/utils";
import type { CodeBlockData } from "@/types/core/code-block";
import type { UploadedImage, UploadedPdf } from "@/types/domain/assets";
...
const getPageNumber = (block: CardBlock): number => {
  const value = Number(block.pdfPageNumber ?? 1);
...
const TextBlockScene = ({ mode, block, editorProps, viewerProps }: Readonly<{ mode: "edit" | "view"; block: CardBlock; editorProps?: EditorProps; viewerProps?: ViewerProps }>) => {
  const isEmpty = (block.content ?? "").trim().length === 0;
  return (
    <SharedBlockShell mode={mode} className={cn("bg-transparent px-0 py-0", !isEmpty && "border-0")} contentClassName="px-0" label="Text" icon={Type} accentColor={editorProps?.accentColor} isBlockSelected={editorProps?.isBlockSelected} onDelete={editorProps?.onDelete} onDuplicate={editorProps?.onDuplicate} onMoveUp={editorProps?.onMoveUp} onMoveDown={editorProps?.onMoveDown} onMoveDragStart={editorProps?.onMoveDragStart} onMoveDragEnd={editorProps?.onMoveDragEnd} canMoveUp={editorProps?.canMoveUp} canMoveDown={editorProps?.canMoveDown} dragHandleClassName="js-block-drag-handle">
...
const QuestionBlockScene = ({ mode, block, editorProps, viewerProps }: Readonly<{ mode: "edit" | "view"; block: CardBlock; editorProps?: EditorProps; viewerProps?: ViewerProps }>) => {
  return (
    <SharedBlockShell mode={mode} className="bg-transparent px-0 py-0" contentClassName="px-0" label="Question" icon={HelpCircle} accentColor={editorProps?.accentColor} isBlockSelected={editorProps?.isBlockSelected} onDelete={editorProps?.onDelete} onDuplicate={editorProps?.onDuplicate} onMoveUp={editorProps?.onMoveUp} onMoveDown={editorProps?.onMoveDown} onMoveDragStart={editorProps?.onMoveDragStart} onMoveDragEnd={editorProps?.onMoveDragEnd} canMoveUp={editorProps?.canMoveUp} canMoveDown={editorProps?.canMoveDown} dragHandleClassName="js-block-drag-handle">
...
const CodeBlockScene = ({ mode, block, meta, editorProps, viewerProps }: Readonly<{ mode: "edit" | "view"; block: CardBlock; meta: BlockListRowMeta; editorProps?: EditorProps; viewerProps?: ViewerProps }>) => {
  ...
  return <div className="w-full max-w-full overflow-visible">{renderGridOffsetSpacer(meta.gridOffsetPx)}<SharedBlockShell mode={mode} className={cn("bg-transparent px-0 py-0", (codeData.code ?? "").trim().length > 0 && "border-0")} contentClassName="relative px-0" label="Code" icon={Code} accentColor={editorProps?.accentColor} isBlockSelected={editorProps?.isBlockSelected} onDelete={editorProps?.onDelete} onDuplicate={editorProps?.onDuplicate} onMoveUp={editorProps?.onMoveUp} onMoveDown={editorProps?.onMoveDown} onMoveDragStart={editorProps?.onMoveDragStart} onMoveDragEnd={editorProps?.onMoveDragEnd} canMoveUp={editorProps?.canMoveUp} canMoveDown={editorProps?.canMoveDown} dragHandleClassName="js-block-drag-handle">{contentNode}</SharedBlockShell></div>;
};

const ImageBlockScene = ({ mode, block, editorProps, viewerProps }: Readonly<{ mode: "edit" | "view"; block: CardBlock; editorProps?: EditorProps; viewerProps?: ViewerProps }>) => {
  const hasItems = (block.images?.length ?? 0) > 0;
  return (
    <SharedBlockShell mode={mode} className={cn("py-0 px-0", hasItems && "border-transparent")} contentClassName="px-0" label="Image" accentColor={editorProps?.accentColor} isBlockSelected={editorProps?.isBlockSelected} onDelete={editorProps?.onDelete} onDuplicate={editorProps?.onDuplicate} onMoveUp={editorProps?.onMoveUp} onMoveDown={editorProps?.onMoveDown} onMoveDragStart={editorProps?.onMoveDragStart} onMoveDragEnd={editorProps?.onMoveDragEnd} canMoveUp={editorProps?.canMoveUp} canMoveDown={editorProps?.canMoveDown} dragHandleClassName="js-block-drag-handle">
      <ImageBlockShell>
...
const PdfBlockScene = ({ mode, block, editorProps, viewerProps }: Readonly<{ mode: "edit" | "view"; block: CardBlock; editorProps?: EditorProps; viewerProps?: ViewerProps }>) => {
  const hasPdf = Boolean(block.pdf);
  const pdf = (block.pdf ?? null) as UploadedPdf | null;
  const pageNumber = getPageNumber(block);
  return (
    <SharedBlockShell mode={mode} className={cn("py-0 px-0", hasPdf && "border-transparent")} contentClassName="px-0" label="PDF" icon={FileText} accentColor={editorProps?.accentColor} isBlockSelected={editorProps?.isBlockSelected} onDelete={editorProps?.onDelete} onDuplicate={editorProps?.onDuplicate} onMoveUp={editorProps?.onMoveUp} onMoveDown={editorProps?.onMoveDown} onMoveDragStart={editorProps?.onMoveDragStart} onMoveDragEnd={editorProps?.onMoveDragEnd} canMoveUp={editorProps?.canMoveUp} canMoveDown={editorProps?.canMoveDown} dragHandleClassName="js-block-drag-handle">
      {mode === "edit" && editorProps ? <PdfBlockContent mode="edit" pdf={pdf} pageNumber={pageNumber} onChange={(nextPdf) => editorProps.onUpdateBlock(block.id, { pdf: nextPdf })} onPageNumberChange={(pdfPageNumber) => editorProps.onUpdateBlock(block.id, { pdfPageNumber })} displayMode={editorProps.displayMode} zoom={editorProps.zoom} /> : <PdfBlockContent mode="view" pdf={pdf} pageNumber={pageNumber} displayMode={viewerProps?.displayMode} zoom={viewerProps?.zoom} />}
    </SharedBlockShell>
  );
};

const AudioBlockScene = ({ mode, block, editorProps, viewerProps }: Readonly<{ mode: "edit" | "view"; block: CardBlock; editorProps?: EditorProps; viewerProps?: ViewerProps }>) => {
  ...
  return <SharedBlockShell mode={mode} className="bg-transparent px-0 py-0" contentClassName="px-0" label="Audio" icon={Volume2} accentColor={editorProps?.accentColor} isBlockSelected={editorProps?.isBlockSelected} onDelete={editorProps?.onDelete} onDuplicate={editorProps?.onDuplicate} onMoveUp={editorProps?.onMoveUp} onMoveDown={editorProps?.onMoveDown} onMoveDragStart={editorProps?.onMoveDragStart} onMoveDragEnd={editorProps?.onMoveDragEnd} canMoveUp={editorProps?.canMoveUp} canMoveDown={editorProps?.canMoveDown} dragHandleClassName="js-block-drag-handle"><div className="rounded-xl border border-slate-200/80 bg-white/70 px-3 py-3 shadow-sm"><AudioPlayer urls={audioUrls} /></div></SharedBlockShell>;
};

const ReferenceBlockScene = ({ mode, block, editorProps }: Readonly<{ mode: "edit" | "view"; block: CardBlock; editorProps?: EditorProps }>) => {
  const references: ReferenceBlockData[] = sanitizeReferences(block.references ?? []);
  return (
    <SharedBlockShell mode={mode} className="bg-transparent px-0 py-0" contentClassName="px-0" label="Reference" icon={Link} accentColor={editorProps?.accentColor} isBlockSelected={editorProps?.isBlockSelected} onDelete={editorProps?.onDelete} onDuplicate={editorProps?.onDuplicate} onMoveUp={editorProps?.onMoveUp} onMoveDown={editorProps?.onMoveDown} onMoveDragStart={editorProps?.onMoveDragStart} onMoveDragEnd={editorProps?.onMoveDragEnd} canMoveUp={editorProps?.canMoveUp} canMoveDown={editorProps?.canMoveDown} dragHandleClassName="js-block-drag-handle">
...
const MathBlockScene = ({ mode, block, meta, editorProps, viewerProps }: Readonly<{ mode: "edit" | "view"; block: CardBlock; meta: BlockListRowMeta; editorProps?: EditorProps; viewerProps?: ViewerProps }>) => {
  ...
  return <SharedBlockShell mode={mode} className={cn(latex.trim().length > 0 && "border-transparent")} label="Math" icon={Sigma} accentColor={editorProps?.accentColor} isBlockSelected={Boolean(editorProps?.isBlockSelected || isEditorOpen)} onDelete={editorProps?.onDelete} onDuplicate={editorProps?.onDuplicate} onMoveUp={editorProps?.onMoveUp} onMoveDown={editorProps?.onMoveDown} onMoveDragStart={editorProps?.onMoveDragStart} onMoveDragEnd={editorProps?.onMoveDragEnd} canMoveUp={editorProps?.canMoveUp} canMoveDown={editorProps?.canMoveDown} dragHandleClassName="js-block-drag-handle"><div className="w-full max-w-full overflow-visible space-y-1.5 px-2 py-0.5">{renderGridOffsetSpacer(meta.gridOffsetPx)}<MathBlockPreviewPane latex={latex} displayMode={mathData.displayMode || "block"} className="rounded-lg" interactive={mode === "edit"} onActivate={mode === "edit" ? () => setIsEditorOpen(true) : undefined} showPlaceholder={mode === "edit"} placeholder={mode === "edit" ? "数式を入力..." : undefined} zoom={mode === "edit" ? editorProps?.zoom : viewerProps?.zoom} />{mode === "edit" && editorProps ? <MathEditorDialog open={isEditorOpen} onOpenChange={setIsEditorOpen} data={mathData} onChange={handleMathChange} accentColor={editorProps.accentColor} error={error} /> : null}</div></SharedBlockShell>;
};

const MarkdownBlockScene = ({ mode, block, editorProps, viewerProps }: Readonly<{ mode: "edit" | "view"; block: CardBlock; editorProps?: EditorProps; viewerProps?: ViewerProps }>) => {
  const [isEditorOpen, setIsEditorOpen] = React.useState(false);
  const markdown = block.markdown ?? "";
  const isEmpty = markdown.trim().length === 0;
  return <SharedBlockShell mode={mode} className={cn("bg-transparent px-0 py-0", !isEmpty && "border-0")} contentClassName="px-0" label="Markdown" icon={NotebookPen} accentColor={editorProps?.accentColor} isBlockSelected={Boolean(editorProps?.isBlockSelected || isEditorOpen)} onDelete={editorProps?.onDelete} onDuplicate={editorProps?.onDuplicate} onMoveUp={editorProps?.onMoveUp} onMoveDown={editorProps?.onMoveDown} onMoveDragStart={editorProps?.onMoveDragStart} onMoveDragEnd={editorProps?.onMoveDragEnd} canMoveUp={editorProps?.canMoveUp} canMoveDown={editorProps?.canMoveDown} dragHandleClassName="js-block-drag-handle">{mode === "edit" && editorProps ? <MarkdownBlockContent mode="edit" markdown={markdown} open={isEditorOpen} onOpenChange={setIsEditorOpen} onChange={(nextMarkdown) => editorProps.onUpdateBlock(block.id, { markdown: nextMarkdown })} onReplaceWithBlocks={editorProps.onReplaceMarkdownWithBlocks} accentColor={editorProps.accentColor} zoom={editorProps.zoom} /> : <MarkdownBlockContent mode="view" markdown={markdown} zoom={viewerProps?.zoom} />}</SharedBlockShell>;
};
...
export const CardBlockSceneRenderer = (props: CardBlockSceneRendererProps) => {
  ...
  switch (block.type) {
    ...
    case "pdf":
      return <PdfBlockScene mode={props.mode} block={block} editorProps={props.mode === "edit" ? props.editorProps : undefined} viewerProps={props.mode === "view" ? props.viewerProps : undefined} />;
    case "audio":
