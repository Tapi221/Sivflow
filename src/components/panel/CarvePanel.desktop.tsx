...
const BODY = "relative isolate flex min-h-0 flex-1 bg-[var(--carvepanel-surface)]";
const TOOLBAR_SPACER = "h-[var(--ds-semantic-breadcrumb-height)] w-full shrink-0 bg-[var(--carvepanel-surface)]";
const LEFT_SPACER =