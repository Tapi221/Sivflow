...
export const pdfOverlayToolbarShellClassName = cn(
  ...
  "bg-[linear-gradient(180deg,#FCFCFD_0%,#F3F4F6_100%)]",
  "shadow-[0_8px_24px_rgba(37,39,45,0.08),inset_0_1px_0_rgba(255,255,255,0.96),inset_0_-1px_0_rgba(226,228,233,0.88)]",
);

export const pdfOverlayToolbarButtonClassName = cn(
  "h-7 w-7 rounded-full border border-[#DDE1E7]",
  "bg-[linear-gradient(180deg,#FFFFFF_0%,#F5F6F8_100%)] text-[#74798B]",
  "shadow-[0_2px_6px_rgba(37,39,45,0.08),inset_0_1px_0_rgba(255,255,255,0.96)]",
  "hover:bg-[linear-gradient(180deg,#FFFFFF_0%,#F2F4F7_100%)] hover:text-[#25272D]",
...
export const pdfOverlayToolbarButtonActiveClassName = cn(
  "border-[#D8DDE5] bg-[linear-gradient(180deg,#FDFDFE_0%,#EFF1F4_100%)] text-[#25272D]",
