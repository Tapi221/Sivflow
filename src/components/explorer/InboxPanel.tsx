            ...
            >
              ...
              <div className="relative" ref={isOpen ? dropdownRef : undefined}>
                <button
                  ...
                  className="opacity-0 group-hover:opacity-100 p-1 hover:bg-slate-200 rounded transition-all flex items-center gap-1 text-xs text-[#6E6E80]"
                  disabled={isMoving}
                >
                ...
                {isOpen && (
                  <div className="absolute right-0 top-full mt-1 w-48 bg-white border border-slate-200 rounded-lg shadow-lg z-50 py-1">
                    <div className="text-xs font-medium text-[#6E6E80] px-3 py-1.5">
                      移動先を選択
                    </div>
                    <div className="border-t border-slate-100">
                      ...
                      {moveFolderOptions.length === 0 && (
                        <div className="text-xs text-[#6E6E80] px-3 py-2 text-center">
                          フォルダがありません
                        </div>
                      )}
                    </div>
