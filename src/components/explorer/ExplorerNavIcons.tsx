...
export const ExplorerFolderNavIcon = ({ className, ...rest }: ExplorerNavIconProps) => {
...
export const ExplorerTagMapNavIcon = ({ className, ...rest }: ExplorerNavIconProps) => {
...
export const ExplorerDictionaryNavIcon = ({ className, ...rest }: ExplorerNavIconProps) => {
...
export const ExplorerQuestionNavIcon = ({ className, ...rest }: ExplorerNavIconProps) => {
