...
const models: Model[] = [
  ...
  { label: "Qwen3 Next 80B A3B Instruct", value: "alibaba/qwen3-next-80b-a3b-instruct" },
  { label: "Qwen3 Next 80B A3B Thinking", value: "alibaba/qwen3-next-80b-a3b-thinking" },
  ...
  { label: "DeepSeek R1 Distill Llama 70B", value: "deepseek/deepseek-r1-distill-llama-70b" },
  ...
  { label: "DeepSeek V3.2 Exp Thinking", value: "deepseek/deepseek-v3.2-exp-thinking" },
  ...
  { label: "Grok 4 Fast Non-Reasoning", value: "xai/grok-4-fast-non-reasoning" },
...
const SettingsDialog = () => {
  ...
  const [tempModel, setTempModel] = React.useState<Model>(() => getDefaultModel());
                      ...
                      <CommandList>
                        <CommandGroup>
                          {models.map((model) => (
                            ...
                            >
                              <Check className={cn("mr-2 size-4", tempModel.value === model.value ? "opacity-100" : "opacity-0")} />
