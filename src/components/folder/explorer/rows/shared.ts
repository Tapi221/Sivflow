...
const EXPLORER_ENTITY_ROW_SHELL_BASE_CLASS = "relative flex w-full cursor-pointer items-center rounded-[8px] px-2";
const EXPLORER_ENTITY_ROW_DENSITY_COMPACT_CLASS = "h-[30px]";
...
const EXPLORER_ROW_INPUT_CLASS = "ds-list-item__input h-[22px] w-full px-1 text-[13px] leading-5 outline-none select-text";
...
const FOLDER_ROW_TITLE_CLASS = "ds-list-item__title truncate text-[14px] font-normal";
