export const EXPLORER_ROW_BASE_CLASS_NAME = "sidebar-row ds-list-item group box-border py-0 relative w-full text-left";
export const EXPLORER_ENTITY_ROW_INTERACTIVE_CLASS = "sidebar-row--folder ds-list-item--interactive";
export const EXPLORER_ENTITY_ROW_SHELL_BASE_CLASS = "relative flex w-full cursor-pointer items-center rounded-[8px] px-2";
export const EXPLORER_ENTITY_ROW_DENSITY_COMPACT_CLASS = "h-[30px]";
export const EXPLORER_ROW_CONTENT_CLASS = "ds-list-item__content flex h-full min-w-0 flex-1 items-center pr-1";
export const EXPLORER_ROW_LEADING_SLOT_CLASS = "sidebar-action flex h-full w-5 shrink-0 items-center justify-center";
export const EXPLORER_ROW_ICON_SLOT_CLASS = "ds-list-item__icon flex h-full w-5 shrink-0 items-center justify-center";
