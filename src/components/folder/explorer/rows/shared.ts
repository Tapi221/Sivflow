...
export const EXPLORER_ROW_LEADING_SLOT_CLASS =
  "sidebar-action flex h-full w-5 shrink-0 items-center justify-center";
export const EXPLORER_ROW_ICON_SLOT_CLASS =
  "ds-list-item__icon flex h-full w-5 shrink-0 items-center justify-center";
...
export const FOLDER_ROW_TITLE_CLASS =
  "ds-list-item__title truncate text-[14px] font-normal";
...
export const getExplorerRowStyle = (depth: number) => ({
  paddingLeft: `calc(12px + ${depth} * var(--tree-indent-px))`,
