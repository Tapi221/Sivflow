...
const PINNED_FOLDER_SECTION_HEADER_ID = "pinned-folder-sidebar-section-header";
  ...
  return (
    <section className="shrink-0 pb-0 pt-1">
      <>
        ...
        <div
          id={FOLDER_LIST_SECTION_HEADER_ID}
          className="mt-1 border-t border-border/60 px-2 pb-1 pt-2"
        >
