...
export const CreateFolderIcon = () => (
  <ExplorerChromeFolderIcon size={15} className={createMenuIconClassName} />
);

export const CreateCardSetIcon = () => (
  <ExplorerChromeCardSetIcon size={15} className={createMenuIconClassName} />
);

export const CreateCardIcon = () => (
  <ExplorerChromeCardIcon size={15} className={createMenuIconClassName} />
);

export const AddDocumentIcon = () => (
  <ExplorerChromePdfIcon size={15} className={createMenuIconClassName} />
);
