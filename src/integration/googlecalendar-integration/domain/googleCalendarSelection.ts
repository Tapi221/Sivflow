...
const resolveSelectedCalendarIds = (storedIds: string[], calendars: GoogleCalendarListItem[]): string[] => { const availableIds = new Set(calendars.map((calendar) => calendar.id));
