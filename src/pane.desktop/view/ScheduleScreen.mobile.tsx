...
const MOBILE_ADD_EVENT_BUTTON_CLASS = "fixed bottom-[calc(env(safe-area-inset-bottom)+64px)] right-6 z-40 flex h-[58px] w-[58px] shrink-0 items-center justify-center rounded-full border border-[rgba(60,60,67,0.08)] bg-white text-[34px] font-light leading-none text-[#3478f6] shadow-[0_4px_16px_rgba(60,60,67,0.16),0_1px_3px_rgba(60,60,67,0.12)] transition active:scale-[0.97] hover:bg-[#fdfdfd] focus:outline-none focus-visible:ring-2 focus-visible:ring-[#3478f6]/30";
