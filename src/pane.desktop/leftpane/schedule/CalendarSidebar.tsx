...
const CALENDAR_SIDEBAR_GOOGLE_LIST_CLASS_NAME = "min-h-0 flex-1 overflow-y-auto pl-4 pr-6 pt-1";
const CALENDAR_SIDEBAR_HEADING_ROW_CLASS_NAME = "group flex min-h-6 items-center gap-1 pl-4 pr-6";
...
const CALENDAR_SIDEBAR_PROJECT_LIST_CLASS_NAME = "max-h-80 shrink-0 overflow-y-auto pl-4 pr-6 pb-1";
