...
const SidebarNavLink = ({
  ...
  return (
    <HoverTooltip label={item.label} side="right" offset={4} className="app-sidebar__nav-tooltip !w-8 !min-w-8" arrowClassName="hidden">
      <button
        type="button"
        onClick={handleClick}
        disabled={isDisabled}
  ...
  return (
    ...
    >
      ...
      <div className="app-sidebar__bottom">
        <HoverTooltip label="ログアウト" side="right" offset={4} className="app-sidebar__nav-tooltip !w-8 !min-w-8" arrowClassName="hidden">
          <button
            type="button"
