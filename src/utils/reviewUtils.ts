...
export const SUBJECTIVE_OPTIONS: Array<{
  ...
  { score: 3, label: '余裕', emoji: '😄', description: 'かなりスムーズに思い出せた' },
  { score: 2, label: '覚えた', emoji: '🙂', description: '少し迷ったが思い出せた' },
  { score: 1, label: 'あいまい', emoji: '😐', description: '思い出しはしたが自信は薄い' },
 ...
 */
export const normalizeMemoryStability = (value?: number | null, legacyLevel?: number | null): number => {
 ...
 */
export const getStabilityPhase = (stabilityInternal: number, intervalDays: number = 1): StabilityPhase => {
  // Normalize S first
