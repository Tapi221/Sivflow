...
export const sanitizeProfileImage = (
  input: unknown,
): SanitizeProfileImageResult => {
  ...
  const updatedAt = remoteUrl
    ? toTimestampOrNow(record.updatedAt)
    : toTimestampOrZero(record.updatedAt);
