declare module 'firebase/firestore' {
  export function collection(firestore: unknown, ...pathSegments: string[]): unknown;
  ...
  export function setDoc(reference: unknown, data: unknown, options?: unknown): Promise<void>;
...
declare module 'firebase/functions' {
  export function getFunctions(app?: unknown, regionOrCustomDomain?: string): unknown;
  export function connectFunctionsEmulator(functionsInstance: unknown, host: string, port: number): void;
