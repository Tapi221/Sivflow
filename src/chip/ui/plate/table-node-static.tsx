...
type TableCellElementStaticProps = SlateElementProps<TTableCellElement> & {
  isHeader?: boolean;
};
...
const TableCellElementStatic = (props: TableCellElementStaticProps) => {
  const { editor, element, isHeader } = props;
