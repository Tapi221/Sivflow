...
type ColorEntry = readonly [name: string, value: string, isBrightColor: boolean];

const DEFAULT_CUSTOM_COLOR_ENTRIES: ColorEntry[] = [
...
const DEFAULT_CUSTOM_COLORS: TColor[] = DEFAULT_CUSTOM_COLOR_ENTRIES.map(([name, value, isBrightColor]) => ({ isBrightColor, name, value }));
const DEFAULT_COLORS: TColor[] = DEFAULT_COLOR_ENTRIES.map(([name, value, isBrightColor]) => ({ isBrightColor, name, value }));

export { DEFAULT_CUSTOM_COLORS, DEFAULT_COLORS };
export type { TColor };
