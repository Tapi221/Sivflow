...
const H2ElementStatic = (props: SlateElementProps) => {
  return <HeadingElementStatic variant="h2" {...props} />;
};
const H3ElementStatic = (props: SlateElementProps) => {
  return <HeadingElementStatic variant="h3" {...props} />;
};
const H4ElementStatic = (props: SlateElementProps) => {
  return <HeadingElementStatic variant="h4" {...props} />;
};
const H5ElementStatic = (props: SlateElementProps) => {
  return <HeadingElementStatic variant="h5" {...props} />;
};
const H6ElementStatic = (props: SlateElementProps) => {
