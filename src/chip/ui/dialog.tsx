...
const DIALOG_CONTENT_SURFACE_CLASS = "grid w-full gap-4 border bg-background p-6 shadow-lg duration-200 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[state=closed]:slide-out-to-left-1/2 data-[state=closed]:slide-out-to-top-[48%] data-[state=open]:slide-in-from-left-1/2 data-[state=open]:slide-in-from-top-[48%] sm:rounded-lg";
const DIALOG_CLOSE_BUTTON_CLASS = "absolute right-4 top-4 rounded-sm opacity-70 ring-offset-background transition-opacity hover:opacity-100 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 disabled:pointer-events-none data-[state=open]:bg-accent data-[state=open]:text-muted-foreground";
...
const DialogContent = React.forwardRef<
  ...
  DialogContentProps
>(({ className, children, accessibleTitle, accessibleDescription, overlayClassName, contentWrapperClassName, closeButtonClassName, showCloseButton = true, surface = "default", ...props }, ref) => {
    ...
    <DialogPortal>
      ...
      <div className={cn(DIALOG_CONTENT_POSITION_CLASS, contentWrapperClassName)}>
        ...
        >
          ...
          {children}
          {showCloseButton ? (
            <DialogPrimitive.Close className={cn(DIALOG_CLOSE_BUTTON_CLASS, closeButtonClassName)}>
              <X className="h-4 w-4" />
