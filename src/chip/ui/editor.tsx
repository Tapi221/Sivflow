...
const editorContainerVariants = cva(
  "relative w-full cursor-text select-text overflow-y-auto caret-foreground focus-visible:outline-none [&_.slate-selection-area]:z-50 [&_.slate-selection-area]:border [&_.slate-selection-area]:border-muted-foreground/30 [&_.slate-selection-area]:bg-muted/60",
  {
    defaultVariants: {
      variant: "default",
    },
    variants: {
      variant: {
        comment: cn(
          ...
          "has-[[data-slate-editor]:focus]:border-muted-foreground/30 has-[[data-slate-editor]:focus]:ring-2 has-[[data-slate-editor]:focus]:ring-muted-foreground/20",
