...
const HOTKEY_BADGE_CLASS_NAME = "ml-auto flex h-5 min-w-8 items-center justify-center gap-0.5 rounded border border-[rgba(0,0,0,0.04)] bg-slate-100 px-1.5 text-xs font-semibold leading-none tracking-tight text-[#85827e]";
