...
const RIGHT_CLICK_PANEL_ITEM_HORIZONTAL_PADDING = 10;
const RIGHT_CLICK_PANEL_TEXT_HORIZONTAL_EDGE = (RIGHT_CLICK_PANEL_SURFACE_PADDING + RIGHT_CLICK_PANEL_ITEM_HORIZONTAL_PADDING) * 2;
