          ...
          <div className="mb-5">
            ...
            <div className="flex gap-2">
              {VISIBLE_DAY_COUNT_OPTIONS.map((count) => {
                ...
                return (
                  <button key={count} type="button" className={cn("rounded-full border px-3 py-1.5 text-[13px] font-semibold", visibleDayCount === visibleCount ? "border-[#007aff] bg-[#e8f2ff] text-[#007aff]" : "border-[#e5e5ea] bg-white text-[#6e6e73]")} onClick={() => { void onChangeVisibleDayCount(visibleCount); }}>
                    {count}日
                  </button>
                );
              })}
