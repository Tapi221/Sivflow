...
export const DateFilterChip = ({ label, onClear }: DateFilterChipProps) => {
  return (
    <span className="flex min-w-0 max-w-[122px] shrink items-center gap-1.5 overflow-hidden rounded-full border border-[#eeeeee] bg-white px-2.5 py-1 text-[12px] font-medium text-[#3a3a3c]">
      ...
      <button
        type="button"
        onClick={onClear}
        className="ml-0.5 flex h-3.5 w-3.5 shrink-0 items-center justify-center rounded-full text-[#9aa0aa] transition-colors hover:text-[#4c5361]"
