...
export const computeEventLayout = (events: LayoutEvent[]): Map<string, LayoutResult> => {
...
export const toLayoutEvent = (id: string, startsAt: Date, minutes: number, minimumDurationMinutes = 0): LayoutEvent => {
