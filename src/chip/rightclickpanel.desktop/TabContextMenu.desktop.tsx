...
export { WORKSPACE_TAB_CONTEXT_PANEL_ID, WORKSPACE_TAB_CONTEXT_MENU_WIDTH, WORKSPACE_TAB_CONTEXT_MENU_HEIGHT, WORKSPACE_TAB_CONTEXT_MENU_MARGIN, WorkspaceTabContextM