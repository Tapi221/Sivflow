...
type CalendarDateHeaderButtonProps = {
  children: ReactNode;
  isToday: boolean;
  isSelected: boolean;
  onClick?: () => void;
...
export const CalendarDateHeaderButton = ({
  children,
  isToday,
  isSelected,
  onClick,
  className,
}: CalendarDateHeaderButtonProps) => {
  return (
    <button
      type="button"
      onClick={onClick}
...
type CalendarDateHeaderDayContentProps = {
  dateLabel: ReactNode;
...
export const CalendarDateHeaderDayContent = ({
  dateLabel,
  weekdayLabel,
  isToday,
  isSelected,
  layout,
}: CalendarDateHeaderDayContentProps) => {
  const weekday = (
    <span
      className={cn(
