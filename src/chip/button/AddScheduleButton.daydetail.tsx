...
export const DayDetailCreateButton = ({
  ...
  return (
    <button
      ...
      onClick={onClick}
      className={cn(
        "group inline-flex h-10 w-fit items-center justify-center gap-2 rounded-[14px] border border-[#dfe3eb] bg-white/95 px-4 text-[13px] font-semibold tracking-[-0.01em] text-[#007aff] shadow-[0_1px_2px_rgba(15,23,42,0.06),0_8px_24px_rgba(15,23,42,0.06)] backdrop-blur-xl",
