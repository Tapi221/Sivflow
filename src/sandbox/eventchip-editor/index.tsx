...
const TEXTAREA_CLASS = "min-h-[72px] w-full resize-y rounded-xl border border-slate-200 bg-white px-3 py-2 text-[12px] font-semibold leading-5 text-slate-700 outline-none focus:border-sky-300 focus:ring-2 focus:ring-sky-100";
const PRESET_BUTTON_CLASS = "rounded-full border border-slate-200 bg-slate-50 px-2.5 py-1 text-[11px] font-semibold text-slate-600 hover:bg-slate-100";
