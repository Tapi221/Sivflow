...
const DropdownMenuItemIcon = ({ className, ...props }: React.HTMLAttributes<HTMLSpanElement>) => (
  <span className={cn("flex size-4 shrink-0 items-center justify-center [&>svg]:size-4 [&>svg]:shrink-0", className)} {...props} />
);
DropdownMenuItemIcon.displayName = "DropdownMenuItemIcon";

const DropdownMenuItemLabel = ({ className, ...props }: React.HTMLAttributes<HTMLSpanElement>) => (
