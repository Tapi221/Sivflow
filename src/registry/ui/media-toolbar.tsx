        ...
        {isEditing ? (
          <div className="flex w-[330px] flex-col">
            <div className="flex items-center">
              ...
              <FloatingMediaPrimitive.UrlInput className={inputVariants()} placeholder="Paste the embed link..." options={{ plugin }} />
            </div>
          </div>
        ) : (
          <div className="box-content flex items-center">
            ...
            <CaptionButton size="sm" variant="ghost">Caption</CaptionButton>
