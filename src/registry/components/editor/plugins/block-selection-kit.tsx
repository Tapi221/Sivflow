...
const hasSelectableClass = ({ attributes, className }: SelectableClassInput) => [className, attributes.className].filter(Boolean).join(' ').includes('slate-selectable');
...
export { BlockSelectionKit, hasSelectableClass };
