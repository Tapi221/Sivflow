...
export const STRATIS_INNER_STROKE_PATH_PROPS: SVGProps<SVGPathElement> = { stroke: "currentColor", strokeWidth: 2, strokeLinecap: "round", strokeLinejoin: "round", vectorEffect: "non-scaling-stroke", shapeRendering: "geometricPrecision", fill: "none" };
const FRAME_PATH =
...
export const StratisFrameIcon = forwardRef<SVGSVGElement, StratisFrameIconProps>(({ className, children, ...props }, ref) => { return (<svg ref={ref} {...props} viewBox="0 0 24 24" className={["block", className].filter(Boolean).join(" ")} xmlns="http://www.w3.org/2000/svg" > <path d={FRAME_PATH} fill="currentColor" /> {children} </svg>);
});
