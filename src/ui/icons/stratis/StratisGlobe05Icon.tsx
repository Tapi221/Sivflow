...
export const StratisGlobe05Icon = forwardRef<
  SVGSVGElement,
  StratisGlobe05IconProps
>(function StratisGlobe05Icon({ className, ...props }, ref) {
  return (
    <svg
      ref={ref}
      {...props}
