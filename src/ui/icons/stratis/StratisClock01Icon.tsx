...
export type StratisClock01IconProps = SVGProps<SVGSVGElement>;

export const StratisClock01Icon = forwardRef<
  SVGSVGElement,
  StratisClock01IconProps
>(function StratisClock01Icon({ className, ...props }, ref) {
  return (
    <svg
      ref={ref}
      {...props}
