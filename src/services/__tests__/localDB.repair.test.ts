      ...
      questionBlocks: [
        {
          ...
          type: 'image',
          orderIndex: 0,
          images: [{ id: 'img-1', localUrl: 'blob:http://localhost/bad', remoteUrl: null, status: 'ready' }],
        },
      ],
      answerBlocks: [],
    } as any);
      ...
      question_blocks: [
        {
          ...
          images: [{ id: 'img-snake', local_url: 'blob:http://localhost/snake', remote_url: null, status: 'ready' }],
        },
      ],
      question_images: [{ id: 'legacy-q', localUrl: 'blob:http://localhost/legacy-q', remoteUrl: null, status: 'ready' }],
      answer_images: [{ id: 'legacy-a', localUrl: 'blob:http://localhost/legacy-a', remoteUrl: null, status: 'ready' }],
    } as any);
        ...
        questionBlocks: [
          {
            ...
            type: 'image',
            orderIndex: 0,
            images: [{ id: 'img-2', localUrl: 'blob:http://localhost/wrong', remoteUrl: null, status: 'uploading' }],
          },
        ],
        answerBlocks: [],
      } as any)
  ...
  it('blocks card update when blob url is included in legacy image fields', async () => {
    ...
    await expect(
      db.updateItem('cards', 'card-f', {
        question_images: [{ id: 'img-f', localUrl: 'blob:http://localhost/legacy-update', remoteUrl: null, status: 'uploading' }],
      } as any)
        ...
        questionBlocks: [
          {
            ...
            type: 'media',
            orderIndex: 0,
            images: [{ id: 'img-g', localUrl: 'blob:http://localhost/direct-put', remoteUrl: null, status: 'uploading' }],
          },
        ],
      } as any)
    ).rejects.toThrow('画像の保存形式が不正');
