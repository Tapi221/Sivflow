...
export const getCardSetSessionDisplayMode = (cardSetId: string | null | undefined) => {
  if (!cardSetId) return null;
  return currentDisplayModeByCardSet.get(cardSetId) ?? null;
};

export const resolveCardSetDisplayMode = (cardSetId: string | null | undefined, defaultDisplayMode: unknown) => {
...
export const setCardSetSessionDisplayMode = (cardSetId: string | null | undefined, mode: CardDisplayMode) => {
  if (!cardSetId) return;
