...
describe('DiffEngine', () => {
  ...
  describe('calculateDiff', () => {
    ...
    it('should detect simple field changes', () => {
      const local = { id: '1', title: 'new title', content: 'hello', updatedAt: 100 };
      const remote = { id: '1', title: 'old title', content: 'hello', updatedAt: 50 };
    ...
    it('should ignore metadata fields', () => {
      const local = { id: '1', title: 'test', updatedAt: 200, lastSyncedAt: 100 };
      const remote = { id: '1', title: 'test', updatedAt: 100, lastSyncedAt: 50 };
  ...
  describe('merge', () => {
    it('should merge remote changes when no local changes', () => {
      const local = { id: '1', title: 'old', updatedAt: 100, lastSyncedAt: 100, localUpdatedAt: 100 };
    ...
    it('should detect conflicts when both sides changed', () => {
      const local = { id: '1', title: 'local change', updatedAt: 100, lastSyncedAt: 50, localUpdatedAt: 100 };
