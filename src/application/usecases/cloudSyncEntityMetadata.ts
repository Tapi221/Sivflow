export type CloudEntityType = | "card" | "folder" | "cardSet" | "document" | "tag" | "asset" | "projectMap" | "userSetting";
...
export const COLLECTION_BY_TYPE: Record<CloudEntityType, string> = { card: "cards", folder: "folders", cardSet: "cardSets", document: "documents", tag: CURRENT_TAG_COLLECTION, asset: "images", projectMap: "projectMaps", userSetting: "userSettings", };
