...
const CALENDAR_SCROLL_BUFFER_CONFIG = {
  calendar: {
    days: {
      unitsPerScreen: 1,
      initialScreens: { before: 3, after: 5 },
      extendScreens: 4,
      maxUnits: { before: 10, after: 14 },
    },
    threeDays: {
      unitsPerScreen: 3,
      initialScreens: { before: 1, after: 1 },
      extendScreens: 2,
      maxUnits: { before: 9, after: 9 },
    },
    week: {
      unitsPerScreen: 7,
      initialScreens: { before: 1, after: 1 },
      extendScreens: 1,
      maxUnits: { before: 14, after: 14 },
    },
    month: {
      unitsPerScreen: 1,
  ...
  timeline: {
    ...
    week: {
      unitsPerScreen: 1,
      initialScreens: { before: 2, after: 4 },
      extendScreens: 4,
      maxUnits: { before: 6, after: 10 },
    },
    month: {
      unitsPerScreen: 1,
      initialScreens: { before: 2, after: 4 },
      extendScreens: 4,
      maxUnits: { before: 4, after: 8 },
    },
    pieChart: {
      unitsPerScreen: 1,
      initialScreens: { before: 0, after: 0 },
