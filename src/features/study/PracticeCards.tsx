    ...
    <div className="reviewMain grid grid-cols-1 lg:grid-cols-[1fr_400px] gap-8">
        ...
        {practiceCurrentCard ? (
          ...
          <Card className="max-w-xl mx-auto border border-slate-200 rounded-3xl">
            <CardContent className="py-10 text-center">
              ...
              <Button
                onClick={() => handlePracticeExit("missing_card")}
      ...
      <div className="hidden lg:block space-y-6">
        <div className="bg-white rounded-3xl p-6 md:p-8 shadow-[0_2px_20px_-4px_rgba(0,0,0,0.05)]">
          <div className="text-[10px] font-bold tracking-[0.2em] text-slate-300 uppercase mb-3 md:mb-4">
            Practice
          </div>
          <div className="space-y-2 text-sm text-slate-600">
            <p>
              ...
              <span className="font-semibold text-slate-700">
                {ratingLabels[practiceState.filterRating]}
              </span>
            </p>
            <p>
              ラウンド:{" "}
              <span className="font-semibold text-slate-700">
                {practiceState.roundNumber}
              </span>
            </p>
            <p>
              OK(累計):{" "}
              <span className="font-semibold text-slate-700">
                {practiceState.doneCount}
              </span>
            </p>
            <p>
              不安(このラウンド):{" "}
              <span className="font-semibold text-slate-700">
                {practiceState.remaining.length}
              </span>
            </p>
          </div>
        </div>
