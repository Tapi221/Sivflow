...
export const resolveLibraryTypeFromPathname = (pathname: string): LibraryContentType | null => {
  switch (normalizePathname(pathname)) {
    case LIBRARY_PDF_PATH: return "pdf";
...
export const resolveLibraryTypeFromSearchParams = (searchParams: URLSearchParams): LibraryContentType | null => {
...
export const resolveLibraryTypeFromLocation = (pathname: string, searchParams: URLSearchParams): LibraryContentType | null => {
