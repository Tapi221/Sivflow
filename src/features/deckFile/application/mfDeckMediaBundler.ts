import {buildMfDeckMediaManifest,
  buildMfDeckMediaPath,
  inferMfDeckMediaExtension,
  inferMfDeckMediaKind,
  MF_DECK_MAX_MEDIA_ENTRY_BYTES,
  MF_DECK_MAX_MEDIA_TOTAL_BYTES,
  toMfDeckMediaUri,} from "@/features/deckFile/domain/mfDeckMedia";
