...
export { MF_DECK_MAX_MEDIA_ENTRY_BYTES, MF_DECK_MAX_MEDIA_TOTAL_BYTES, isMfDeckMediaPath, toMfDeckMediaUri, isMfDeckMediaUri, pathFromMfDeckMediaUri, inferMfDeckMediaKind, inferMfDeckMediaExtension, sanitizeMfDeckMediaName, buildMfDeckMediaPath, buildMfDeckMediaManifes