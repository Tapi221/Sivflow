...
const CARD_VIEW_COMPACT_MODE_BUTTON_CLASS_NAME = "h-7 w-7 border-0 bg-transparent text-[#85827e] shadow-none transition-colors hover:bg-[#eee] hover:text-[#2f343b] disabled:bg-transparent disabled:text-[#b7b7b7] disabled:opacity-50";
const CARD_VIEW_COMPACT_MODE_BUTTON_ACTIVE_CLASS_NAME = "bg-[#eee] text-[#2f343b]";
const CARD_VIEW_COMPACT_DIVIDER_CLASS_NAME = "bg-[#dedbd7]";
const CARD_VIEW_COMPACT_INDEX_CLASS_NAME = "text-[#85827e]";
const CARD_VIEW_COMPACT_INDEX_INPUT_CLASS_NAME = "h-7 rounded-[7px] border-0 bg-transparent text-[#2f343b] shadow-none hover:bg-[#eee] focus:border-transparent focus:bg-[#eee]";
