...
const CARD_VIEW_COMPACT_INDEX_INPUT_CLASS_NAME = "h-7 rounded-[7px] border-0 bg-transparent text-[#2f343b] shadow-none hover:bg-[#eeeeee] focus:border-transparent focus:bg-[#eeeeee]";
