...
const CardSetViewMobileEmptyState = ({ cardSetName, onCreateCard }: CardSetViewMobileEmptyStateProps) => {
  ...
  return (
    <div className="flex h-full min-h-0 w-full items-center justify-center px-6 py-8">
      <div className="flex max-w-[360px] flex-col items-center rounded-[26px] border border-[#e7e5de] bg-white px-7 py-7 text-center shadow-[0_18px_70px_rgba(15,23,42,0.08)]">
...
const CardSetViewMobile = ({ cardsForPager, selectedCardId, safeCurrentIndex, isFlipped, isLoading, cardSetName, currentDisplayMode, settings, onIndexChange, onFlip, onEdit, onCreateCard, onToggleUncertainty, onToggleBookmark }: CardSetViewMobileProps) => { void selectedCardId;
  void settings;
  void onEdit;
