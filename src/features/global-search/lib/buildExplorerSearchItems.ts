...
export const buildExplorerSearchItems = ({
  ...
  const folderItems: GlobalSearchItem[] = activeFolders.map((folder) => {
  ...
  const cardSetItems: GlobalSearchItem[] = activeCardSets.map((cardSet) => {
  ...
  const cardItems: GlobalSearchItem[] = activeCards.map((card) => {
  ...
  const documentItems: GlobalSearchItem[] = activeDocuments.map((document) => {
