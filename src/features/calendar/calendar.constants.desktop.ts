...
export const INITIAL_MONTH_BUFFER = 6;
export const MONTH_EXTEND_COUNT = 3;
export const MONTH_MAX_RENDERED_MONTHS = 15;
export const MONTH_VIEW_EVENT_RANGE_BUFFER_DAYS = 7;

export const MONTH_SCROLL_EDGE_THRESHOLD_PX = 1600;
