...
export const CalendarPanelViewport = forwardRef<HTMLDivElement, CalendarPanelViewportProps>(({ children, hasTrailingPanel = false, className }, ref) => {
...
export const CalendarPanel = ({ children, hasTrailingPanel = false, className }: CalendarPanelProps) => {
