...
export const createCalendarEventsScopeKey = (rangeStart: Date, rangeEnd: Date): string =>
  `${rangeStart.toISOString()}|${rangeEnd.toISOString()}`;

export const useTransientEmptyCalendarEvents = (
  events: GoogleCalendarEvent[],
  scopeKey: string,
  holdMs = TRANSIENT_EMPTY_CALENDAR_EVENTS_HOLD_MS,
): GoogleCalendarEvent[] => {
