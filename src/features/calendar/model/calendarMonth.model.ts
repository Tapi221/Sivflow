...
export const buildCalendarMonthGridDays = (baseDate: Date, weekStartDay: CalendarWeekStartDay = DEFAULT_CALENDAR_MONTH_WEEK_START_DAY): CalendarMonthGridDay[] => {
...
export const buildCalendarMonthPages = ({ anchorDate, startOffset, endOffset, weekStartDay = DEFAULT_CALENDAR_MONTH_WEEK_START_DAY }: {
  anchorDate: Date;
  startOffset: number;
  endOffset: number;
...
export const buildCalendarMonthWeeks = ({ anchorDate, startOffset, endOffset, weekStartDay = DEFAULT_CALENDAR_MONTH_WEEK_START_DAY }: {
  anchorDate: Date;
  startOffset: number;
  endOffset: number;
  weekStartDay?: CalendarWeekStartDay;
