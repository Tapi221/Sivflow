...
const END_OF_DAY_HOUR_LABEL = "24";
      ...
      <div ref={allDayScrollRef} className="relative z-20 shrink-0 overflow-hidden border-b bg-white" style={WEEKDAY_COLUMN_BORDER_STYLE}>
        <div className="grid min-w-0" style={{ gridTemplateColumns }}>
          ...
          {visibleDays.map((day, dayIndex) => {
            ...
            return (
              <div key={dayKey} ref={setAllDayColumnRef(dayKey)} className={cn("min-h-10 min-w-0 px-px pb-1 pt-[2px]", dayIndex === 0 ? null : "border-l")} style={WEEKDAY_COLUMN_BORDER_STYLE}>
