...
const getHourLabelClassName = (hour: number): string => cn("absolute right-2 z-10 bg-white px-1", hour === 0 ? "top-1 translate-y-0" : "top-0 -translate-y-1/2", WEEKDAY_TIME_LABEL_CLASS_NAME);
