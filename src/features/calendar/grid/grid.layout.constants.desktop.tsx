...
export const MONTH_GRID_DAY_NUMBER_POSITION_CLASS = "left-3 top-1 z-30";
export const MONTH_GRID_MONTH_ANNOTATION_POSITION_CLASS = "right-3 top-[8px] z-30";
export const MONTH_GRID_EVENTS_CONTAINER_POSITION_CLASS = "inset-x-1 top-8 z-20";
