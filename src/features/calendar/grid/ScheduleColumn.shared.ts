...
export const getScheduleViewStart = (anchorDate: Date, viewMode: CalendarViewMode, weekStartDay: CalendarWeekStartDay = DEFAULT_CALENDAR_MONTH_WEEK_START_DAY) => {
...
export const getScheduleViewDayCount = (anchorDate: Date, viewMode: CalendarViewMode) => {
  if (viewMode === "year") {
...
export const buildScheduleDisplayDays = (anchorDate: Date, viewMode: CalendarViewMode, weekStartDay: CalendarWeekStartDay = DEFAULT_CALENDAR_MONTH_WEEK_START_DAY) => {
...
export const buildScheduleInteractionDays = (anchorDate: Date, viewMode: CalendarViewMode, buffer: ScheduleColumnBuffer, weekStartDay: CalendarWeekStartDay = DEFAULT_CALENDAR_MONTH_WEEK_START_DAY) => {
...
export const buildScheduleVirtualRail = (anchorDate: Date, viewMode: CalendarViewMode, buffer: ScheduleColumnBuffer, weekStartDay: CalendarWeekStartDay = DEFAULT_CALENDAR_MONTH_WEEK_START_DAY): ScheduleVirtualRail => {
  const displayDays = buildScheduleDisplayDays(anchorDate, viewMode, weekStartDay);
  const baseStart = displayDays[0] ?? getScheduleViewStart(anchorDate, viewMode, weekStartDay);
...
export const buildScheduleVirtualRailDays = (rail: ScheduleVirtualRail, startIndex: number, endIndex: number): Date[] => {
...
export const getScheduleVirtualRailDate = (rail: ScheduleVirtualRail, index: number): Date | null => {
