    ...
    >
      ...
      <div className="flex items-center min-w-0 pr-3 py-[9px]">
        ...
        <button
          ...
          className="ml-2 flex h-5 w-5 flex-shrink-0 items-center justify-center rounded opacity-0 transition-[background-color,color,opacity] text-[#c7c7cc] hover:bg-[#fee2e2] hover:text-[#ff3b30] group-hover/row:opacity-100 focus-visible:opacity-100"
        >
...
export const TaskListView = ({ tasks, onToggleTaskDone, onRenameTask, onDeleteTask }: TaskListViewProps) => {
