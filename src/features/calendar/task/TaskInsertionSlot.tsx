...
export const TaskInsertionSlot = ({
  ...
  return (
    ...
    >
      <div
        className={cn(
          "pointer-events-none absolute left-0 right-0 top-1/2 -translate-y-1/2 rounded-full",
          "transition-[height,opacity,transform,box-shadow] duration-[160ms] ease-[cubic-bezier(.22,1,.36,1)]",
          isActive
