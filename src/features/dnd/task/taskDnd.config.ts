...
export const TASK_DND_LAYOUT_ANIMATION_DURATION_MS = 300;
export const TASK_DND_DRAG_LAYOUT_ANIMATION_DURATION_MS = 0;

export const TASK_DND_DROP_ANIMATION: DropAnimation | null = null;

export const TASK_DND_POINTER_ACTIVATION_DISTANCE = 0;
