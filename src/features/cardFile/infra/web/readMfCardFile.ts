import { MF_CARD_FILE_EXTENSION, type MfCardFileV1, type MfCardIssue, MfCardValidationError } from "@/features/cardFile/domain/mfCardTypes";
...
export const buildMfCardImportCardSetName = ({
  fileName,
  title,
}: {
  fileName: string;
...
export const readMfCardFile = async (
  file: File,
): Promise<LoadMfCardFileResult> => {
