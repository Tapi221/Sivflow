...
const stripMfCardExtension = (value: string) => { return value.replace(/\.mfcard$/iu, "").trim();
};
const formatCardFileDisplayName = (rawName: string | null | undefined) => { const normalizedName = rawName?.trim() || "無題のカード";
