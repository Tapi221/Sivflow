...
const WORKSPACE_BREADCRUMBS_CLASS_NAME = "pointer-events-auto absolute left-8 top-[15px] z-30 flex h-7 max-w-[calc(100%-604px)] min-w-0 items-center overflow-hidden font-[var(--app-font-family-sidebar)] text-[14px] font-[650] leading-none tracking-[-0.018em] text-[#7d7b78]";
