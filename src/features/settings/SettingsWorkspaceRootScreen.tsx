...
type SettingOption<T extends string | number> = { value: T; label: string };
type SettingToggleProps = { label: string; checked: boolean; onChange: (checked: boolean) => void; description?: string };
type SettingChoiceRowProps<T extends string | number> = { label: string; value: T; options: readonly SettingOption<T>[]; onChange: (value: T) => void };
type SettingKeyValueProps = { label: string; value: ReactNode };
type SettingTextInputRowProps = { label: string; value: string; onChange: (value: string) => void; description?: string; placeholder?: string };
type AccountProfile = { displayName: string | null; email: string | null; photoUrl: string | null; providerId: string | null };
type Copy = {
