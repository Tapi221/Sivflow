          ...
          {activeSectionId === "account" ? (
            <SettingsSectionBlock title={copy.accountProfileTitle} description={copy.accountProfileDescription}>
              <div className="settings-workspace__profile-card">
                <div className="settings-workspace__avatar" aria-hidden="true">{accountProfile.photoUrl ? <img src={accountProfile.photoUrl} alt="" referrerPolicy="no-referrer" /> : <span>{accountInitial}</span>}</div>
