...
export const pdfOverlayToolbarShellClassName = cn(
  "translate-y-[8px] rounded-[24px] border border-white/70",
  "bg-[rgba(248,250,252,0.72)] text-[#1D1D1F] backdrop-blur-[22px] backdrop-saturate-[180%]",
  "shadow-[0_12px_28px_rgba(15,23,42,0.12),0_1px_5px_rgba(15,23,42,0.07),inset_0_1px_0_rgba(255,255,255,0.86),inset_0_-1px_0_rgba(255,255,255,0.32)]",
);

export const pdfOverlayToolbarButtonClassName = cn(
  "h-7 w-7 rounded-full border border-white/65",
  "bg-white/55 text-[#1D1D1F] backdrop-blur-[16px]",
  "shadow-[0_1px_2px_rgba(15,23,42,0.07),inset_0_1px_0_rgba(255,255,255,0.84)]",
...
export const pdfOverlayToolbarDividerClassName =
  "h-4 w-px shrink-0 bg-[#3C3C43]/12";

export const pdfOverlayToolbarNavigatorClassName = "text-[#8E8E93]";

export const pdfOverlayToolbarNavigatorInputClassName = cn(
  "h-7 w-12 rounded-[16px] border border-white/65 bg-white/58 px-2 text-[10px]",
  "text-[#1D1D1F] shadow-[inset_0_1px_2px_rgba(15,23,42,0.07),inset_0_1px_0_rgba(255,255,255,0.86)]",
  "focus:border-[#007AFF]/35 focus:bg-white/82 focus:ring-2 focus:ring-[#007AFF]/16 sm:w-14",
);
...
export const pdfOverlayToolbarSliderThumbClassName = cn(
  ...
  "[&::-webkit-slider-thumb]:shadow-[0_2px_6px_rgba(15,23,42,0.16),0_0_0_0.5px_rgba(60,60,67,0.12)]",
  "[&::-moz-range-thumb]:h-4 [&::-moz-range-thumb]:w-4 [&::-moz-range-thumb]:border-white/80 [&::-moz-range-thumb]:bg-white",
  "[&::-moz-range-thumb]:shadow-[0_2px_6px_rgba(15,23,42,0.16),0_0_0_0.5px_rgba(60,60,67,0.12)]",
);
