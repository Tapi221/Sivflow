...
const patchPdfViewerSetDocument = (prototype: PatchedPdfViewerPrototype): void => {
  ...
  prototype.setDocument = function setDocument(this: PatchedPdfViewerPrototype, ...args: unknown[]) {
...
const applyPdfViewerZoomPatch = (): void => {
  ...
  prototype.scrollPageIntoView = function scrollPageIntoView(this: PatchedPdfViewerPrototype, ...args: unknown[]) {
