...
export const resolveCardSurfaceMode = (displayMode?: CardDisplayMode): CardSurfaceMode => {
  return displayMode === "fluid" ? "fluid" : "card";
};
export const buildCardRenderSpec = ({ displayMode, interactionMode, zoomScale, showInk }: {
