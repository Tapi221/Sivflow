...
export interface CardRenderSpec { surfaceMode: CardSurfaceMode;
...
export const resolveCardSurfaceMode = ( displayMode?: CardDisplayMode, ): CardSurfaceMode => { return displayMode === "fluid" ? "fluid" : "card";
};

export const buildCardRenderSpec = ({ displayMode, interactionMode, zoomScale, showInk, }: { displayMode?: CardDisplayMode;
  interactionMode: CardInteractionMode;
  zoomScale?: number;
  showInk?: boolean;
}): CardRenderSpec => {
...
export const resolveCardSurfaceScale = (spec: CardRenderSpec) => { return spec.surfaceMode === "card" ? spec.zoomScale : 1;
};

export const resolveCardContentZoom = (spec: CardRenderSpec) => { return spec.surfaceMode === "fluid" ? spec.zoomScale : 1;
};

export const resolveCardUsesSurfaceScale = (spec: CardRenderSpec) => { return spec.surfaceMode === "card";
};
