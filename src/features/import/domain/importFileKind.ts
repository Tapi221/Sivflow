...
export const detectImportFileKind = (file: Pick<File, "name" | "type">): ImportFileKind => {
...
export const isSupportedImportFileKind = (kind: ImportFileKind): kind is Exclude<ImportFileKind, "unknown"> => {
  return kind !== "unknown";
};
export const isPortableImportFileKind = (kind: ImportFileKind): kind is PortableImportFileKind => {
