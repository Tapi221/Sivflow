...
async function verifySecuritySignal() {
    ...
    const unsubscribe = userRef.onSnapshot((snap) => {
        ...
        if (data === null || data === void 0 ? void 0 : data.isAccountLocked) {
    ...
    setTimeout(async () => {
        ...
        await db.collection(`users/${testUserId}/securityLogs`).add(Object.assign(Object.assign({}, highRiskLog), { timestamp: Timestamp.now(), details: { reason: 'Second Hit' } }));
    }, 2000);
    setTimeout(() => {
...
//# sourceMappingURL=verify_security_signal_v2.js.map