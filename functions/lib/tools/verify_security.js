...
async function main() {
    ...
    const score1 = (_a = status1.data()) === null || _a === void 0 ? void 0 : _a.riskScore;
    ...
    const isLocked = (_b = userDoc.data()) === null || _b === void 0 ? void 0 : _b.isAccountLocked;
    ...
    const devStatus = (_c = devDoc.data()) === null || _c === void 0 ? void 0 : _c.status;
    console.log(`[Verify 2] Device Status: ${devStatus} (Expected: revoked)`);
    const status2 = await db.doc(`users/${userId}/security/status`).get();
    const score2 = (_d = status2.data()) === null || _d === void 0 ? void 0 : _d.riskScore;
