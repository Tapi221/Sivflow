...
export const CalendarWorkspaceToolbar = ({
  ...
  return (
    <div
      className={cn(
        "relative flex h-[var(--ds-semantic-breadcrumb-height)] w-full shrink-0 flex-wrap items-center overflow-hidden bg-white after:absolute after:bottom-1 after:left-0 after:right-0 after:h-px after:bg-[#e2e4e9] after:content-['']",
        hideTabs ? "justify-end" : "justify-between",
      )}
    >
      {!hideTabs ? (
