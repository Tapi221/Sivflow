...
export class PdfAdapter extends BaseAdapter<PdfAdapterFile> {
  ...
  private async _createListContent(
    ...
    const blueColor = resolveCssVariable('var(--sivflow-blue-700)') || '#1E96EB';
  ...
  private async _createCalloutContent(
    ...
    const colorVar =
      backgroundColorName === 'default' || backgroundColorName === 'grey'
        ? 'var(--sivflow-v2-block-callout-background-grey)'
        : `var(--sivflow-v2-block-callout-background-${backgroundColorName})`;
