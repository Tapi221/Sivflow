...
const TOOLTIP_FOREGROUND_COLOR =
  'var(--sivflow-v2-tooltips-foreground, var(--affine-v2-tooltips-foreground, var(--sivflow-white, var(--affine-white))))';
const TOOLTIP_BACKGROUND_COLOR =
  'var(--sivflow-v2-tooltips-background, var(--affine-v2-tooltips-background, var(--sivflow-tooltip, var(--affine-tooltip))))';
...
const styles = css`
  .affine-tooltip {
    ...
    max-width: 280px;
    min-height: 32px;
    font-family: var(--sivflow-font-family, var(--affine-font-family));
    font-size: var(--sivflow-font-sm, var(--affine-font-sm));
    border-radius: 4px;
    padding: 6px 12px;
    color: ${unsafeCSS(TOOLTIP_FOREGROUND_COLOR)};
    background: ${unsafeCSS(TOOLTIP_BACKGROUND_COLOR)};
...
const TOOLTIP_ARROW_COLOR = TOOLTIP_BACKGROUND_COLOR;
 ...
 *   .autoFlip=${true}
 *   .arrow=${true}
 *   .tooltipStyle=${css`:host { z-index: 0; --sivflow-tooltip: #fff; }`}
...
export class Tooltip extends LitElement {
  ...
  accessor zIndex: number | string =
    'var(--sivflow-z-index-popover, var(--affine-z-index-popover))';
}
