...
export const embedCardModalStyles = css`
  ...
  .embed-card-modal-input {
    ...
    padding-right: 10px;
    border-radius: 8px;
    border: 1px solid var(--sivflow-border-color);
    background: var(--sivflow-white-10);
  ...
  .embed-card-modal-input:focus {
    border-color: var(--sivflow-blue-700);
    box-shadow: var(--sivflow-active-shadow);
    outline: none;
  }
  .embed-card-modal-input::placeholder {
    color: var(--sivflow-placeholder-color);
  }
  ...
  .embed-card-modal-button.save {
    border: 1px solid var(--sivflow-black-10);
  ...
  .embed-card-modal-button[disabled] {
    pointer-events: none;
    cursor: not-allowed;
    color: var(--sivflow-text-disable-color);
  ...
  .embed-card-modal-button.reset {
    ...
    color: var(--sivflow-secondary-color);
    user-select: none;
  }
