import { panelBaseColorsStyle, scrollbarStyle } from '@blocksuite/affine-shared/styles';
import {
...
export class EditorMenuContent extends LitElement {
  static override styles = css`
    ...
    ${panelBaseColorsStyle('.content-wrapper')}
...
export class EditorMenuAction extends LitElement {
  static override styles = css`
    ...
    :host(:hover),
    :host([data-selected]) {
      background-color: var(--sivflow-hover-color);
    }
    ...
    :host(:hover.delete) ::slotted(svg) {
      background-color: var(--sivflow-background-error-color);
      color: var(--sivflow-error-color);
    }
