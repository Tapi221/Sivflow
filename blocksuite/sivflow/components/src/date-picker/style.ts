...
export const datePickerStyle = css`
  ...
  .date-picker {
    ...
    gap: var(--gap-v);
    font-family: var(--sivflow-font-family);
  }

  .popup.date-picker {
    background: var(--sivflow-background-overlay-panel-color);
    border-radius: 12px;
  ...
  .date-picker-small-action:hover {
    color: var(--sivflow-icon-hover-color);
    background: var(--sivflow-icon-hover-background);
  }
  ...
  .date-picker-header__date {
    ...
    align-items: center;
    gap: 4px;
    color: var(--sivflow-text-primary-color);
    font-weight: 600;
    padding: 2px;
    border-radius: 4px;
    font-size: 14px;
  ...
  .days-header > div {
    color: var(--sivflow-text-secondary-color);
    font-weight: 500;
    font-size: 12px;
    cursor: default;
  }
  ...
  .date-cell.date-cell--today {
    color: var(--sivflow-primary-color);
    font-weight: 600;
  }

  .date-cell.date-cell--selected {
    background: var(--sivflow-primary-color);
    color: var(--sivflow-pure-white);
    font-weight: 500;
  }
  ...
  .interactive:hover::after {
    background: var(--sivflow-hover-color);
  }
  ...
  .interactive::before {
    opacity: 0;
    transition: none;
    box-shadow: 0 0 0 3px var(--sivflow-primary-color);
  }
  ...
  .interactive:focus-visible {
    outline: none;
    outline: 1px solid var(--sivflow-primary-color);
  }
  ...
  .date-picker-footer {
    margin-top: 8px;
    padding-top: 8px;
    border-top: 1px solid var(--sivflow-border-color);
  }
