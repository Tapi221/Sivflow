...
export class HighlightDropdownMenu extends LitElement {
  ...
  override render() {
    const prefix = '--sivflow-text-highlight';
        ...
        .button=${html`
          <editor-icon-button aria-label="highlight" .tooltip="${'Highlight'}">
            <affine-highlight-duotone-icon
              style=${styleMap({
                '--color':
                  // latestHighlightColor ?? 'var(--sivflow-text-primary-color)',
                  'var(--sivflow-text-primary-color)',
              })}
            ></affine-highlight-duotone-icon>
            ${EditorChevronDown}
          </editor-icon-button>
            ...
            return html`
              ...
              >
                <affine-text-duotone-icon
                  style=${styleMap({
                    '--color': value ?? 'var(--sivflow-text-primary-color)',
                  })}
                ></affine-text-duotone-icon>
