...
const pageTitles: Record<Exclude<Page, 'custom'>, string> = {
  main: 'com.affine.data-view.view-settings.main',
  properties: 'com.affine.data-view.view-settings.properties',
  filter: 'com.affine.data-view.view-settings.filter',
  sort: 'com.affine.data-view.view-settings.sort',
  group: 'com.affine.data-view.view-settings.group',
  'group-select': 'com.affine.data-view.view-settings.group-by',
};

const defaultPageTitles: Record<Exclude<Page, 'custom'>, string> = {
  main: 'View settings',
...
export const popViewOptions = (
  ...
  const t = dataViewLogic.root.config.i18n?.t ?? (key => key);
  ...
  const titleConfig = {
    get text() {
      ...
      const key = pageTitles[currentPage.value as Exclude<Page, 'custom'>] ?? pageTitles.main;
      const defaultText = defaultPageTitles[currentPage.value as Exclude<Page, 'custom'>] ?? defaultPageTitles.main;
      return t(key) !== key ? t(key) : defaultText;
    },
    ...
    get postfix() {
      ...
      return () =>
        ...
        >
          ${isAllShowed
            ? t('com.affine.data-view.view-settings.hide-all') !== 'com.affine.data-view.view-settings.hide-all'
              ? t('com.affine.data-view.view-settings.hide-all')
              : 'Hide All'
            : t('com.affine.data-view.view-settings.show-all') !== 'com.affine.data-view.view-settings.show-all'
              ? t('com.affine.data-view.view-settings.show-all')
              : 'Show All'}
        </div>`;
    },
    get onClose() {
  ...
  const getFilterPageItems = (): MenuConfig[] => {
    ...
    return [
      ...
      menu.group({
        items: [
          menu.action({
            name: t('com.affine.data-view.view-settings.add') !== 'com.affine.data-view.view-settings.add' ? t('com.affine.data-view.view-settings.add') : 'Add',
            prefix: PlusIcon(),
            select: ele => {
  ...
  const getSortPageItems = (): MenuConfig[] => {
    ...
    return [
      ...
      menu.action({
        name: t('com.affine.data-view.view-settings.add-sort') !== 'com.affine.data-view.view-settings.add-sort' ? t('com.affine.data-view.view-settings.add-sort') : 'Add sort',
        prefix: PlusIcon(),
        select: ele => {
      ...
      menu.action({
        name: t('com.affine.data-view.view-settings.delete') !== 'com.affine.data-view.view-settings.delete' ? t('com.affine.data-view.view-settings.delete') : 'Delete',
  ...
  const getMainPageItems = (): MenuConfig[] => {
    ...
    items.push(
      menu.input({
        ...
        placeholder: t('com.affine.data-view.view-settings.view-name') !== 'com.affine.data-view.view-settings.view-name' ? t('com.affine.data-view.view-settings.view-name') : 'View name',
          ...
          menuObj => {
            const viewTypeItems = menuObj.renderItems(
              view.manager.viewMetas.map<MenuConfig>(meta => {
                return menuObj => {
                  const defaultName = typeof meta.model.defaultName === 'function' ? meta.model.defaultName() : meta.model.defaultName;
                  if (!menuObj.search(defaultName)) {
                    return;
                  }
                  const isSelected =
                  ...
                  const buttonData: MenuButtonData = {
                    content: () => html`
                      ...
                      >
                        ...
                        <div style="${textStyle}">
                          ${typeof meta.model.defaultName === 'function' ? meta.model.defaultName() : meta.model.defaultName}
                        </div>
                      </div>
                    `,
                    select: () => {
            ...
            return html`
              ...
              >
                ...
                >
                  ${t('com.affine.data-view.view-settings.layout') !== 'com.affine.data-view.view-settings.layout' ? t('com.affine.data-view.view-settings.layout') : 'Layout'}
                </div>
              </div>
    ...
    settingItems.push(
      menu.action({
        name: t('com.affine.data-view.view-settings.properties') !== 'com.affine.data-view.view-settings.properties' ? t('com.affine.data-view.view-settings.properties') : 'Properties',
        prefix: InfoIcon(),
        closeOnSelect: false,
        postfix: html`
          <div style="font-size: 14px;">
            ${view.properties$.value.length} ${t('com.affine.data-view.view-settings.shown') !== 'com.affine.data-view.view-settings.shown' ? t('com.affine.data-view.view-settings.shown') : 'shown'}
          </div>
          ${ArrowRightSmallIcon()}
        `,
        select: () => {
    ...
    if (filterTrait) {
      ...
      settingItems.push(
        menu.action({
          name: t('com.affine.data-view.view-settings.filter') !== 'com.affine.data-view.view-settings.filter' ? t('com.affine.data-view.view-settings.filter') : 'Filter',
          prefix: FilterIcon(),
          closeOnSelect: false,
          postfix: html`
            <div style="font-size: 14px;">
              ${filterCount === 0
                ? ''
                : filterCount === 1
                  ? `1 ${t('com.affine.data-view.view-settings.active') !== 'com.affine.data-view.view-settings.active' ? t('com.affine.data-view.view-settings.active') : 'active'}`
                  : `${filterCount} ${t('com.affine.data-view.view-settings.active') !== 'com.affine.data-view.view-settings.active' ? t('com.affine.data-view.view-settings.active') : 'active'}`}
            </div>
            ${ArrowRightSmallIcon()}
          `,
          select: () => {
    ...
    if (sortTrait) {
      ...
      settingItems.push(
        menu.action({
          name: t('com.affine.data-view.view-settings.sort') !== 'com.affine.data-view.view-settings.sort' ? t('com.affine.data-view.view-settings.sort') : 'Sort',
          prefix: SortIcon(),
          closeOnSelect: false,
          postfix: html`
            <div style="font-size: 14px;">
              ${sortCount === 0
                ...
                : sortCount === 1
                  ? `1 ${t('com.affine.data-view.view-settings.active') !== 'com.affine.data-view.view-settings.active' ? t('com.affine.data-view.view-settings.active') : 'active'}`
                  : `${sortCount} ${t('com.affine.data-view.view-settings.active') !== 'com.affine.data-view.view-settings.active' ? t('com.affine.data-view.view-settings.active') : 'active'}`}
            </div>
            ${ArrowRightSmallIcon()}
          `,
          select: () => {
    ...
    if (groupTrait) {
      settingItems.push(
        menu.action({
          name: t('com.affine.data-view.view-settings.group') !== 'com.affine.data-view.view-settings.group' ? t('com.affine.data-view.view-settings.group') : 'Group',
          prefix: GroupingIcon(),
          closeOnSelect: false,
          postfix: html`
            <div style="font-size: 14px;">
    ...
    items.push(
      menu.group({
        items: [
          menu.action({
            name: t('com.affine.data-view.view-settings.duplicate-view') !== 'com.affine.data-view.view-settings.duplicate-view' ? t('com.affine.data-view.view-settings.duplicate-view') : 'Duplicate view',
          ...
          menu.action({
            name: t('com.affine.data-view.view-settings.delete-view') !== 'com.affine.data-view.view-settings.delete-view' ? t('com.affine.data-view.view-settings.delete-view') : 'Delete view',
            prefix: DeleteIcon(),
            closeOnSelect: false,
            select: () => {
              view.delete();
