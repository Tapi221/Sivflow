...
export class DatabaseHeaderColumn extends SignalWatcher(
  ...
  private readonly _clickTypeIcon = (event: MouseEvent) => {
    ...
    const i18n = this.tableViewManager.serviceGet(I18nStringProvider);
    ...
    popMenu(popupTargetFromElement(ele ?? this), {
      options: {
        items: [
          ...
          // Number format begin
          menu.subMenu({
            name: t('com.affine.data-view.property-menu.number-format', 'Number Format'),
            hide: () =>
          ...
          menu.group({
            items: [
              menu.action({
                name: t('com.affine.data-view.property-menu.hide-in-view', 'Hide In View'),
                prefix: ViewIcon(),
          ...
          menu.group({
            items: [
              menu.action({
                name: t('com.affine.data-view.property-menu.filter', 'Filter'),
                prefix: FilterIcon(),
                select: () => this._addFilter(),
              }),
              menu.action({
                name: t('com.affine.data-view.property-menu.sort-ascending', 'Sort Ascending'),
                prefix: SortIcon(),
                select: () => this._addSort(false),
              }),
              menu.action({
                name: t('com.affine.data-view.property-menu.sort-descending', 'Sort Descending'),
                prefix: SortIcon(),
          ...
          menu.group({
            items: [
              menu.action({
                name: t('com.affine.data-view.property-menu.insert-left-column', 'Insert Left Column'),
              ...
              menu.action({
                name: t('com.affine.data-view.property-menu.insert-right-column', 'Insert Right Column'),
              ...
              menu.action({
                name: t('com.affine.data-view.property-menu.move-left', 'Move Left'),
                prefix: MoveLeftIcon(),
              ...
              menu.action({
                name: t('com.affine.data-view.property-menu.move-right', 'Move Right'),
          ...
          menu.group({
            items: [
              menu.action({
                name: t('com.affine.data-view.property-menu.duplicate', 'Duplicate'),
              ...
              menu.action({
                name: t('com.affine.data-view.property-menu.delete', 'Delete'),
                prefix: DeleteIcon(),
