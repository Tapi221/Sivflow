...
export class RecordField extends SignalWatcher(
  ...
  static override styles = css`
    ...
    .field-content.is-editing {
      box-shadow: 0px 0px 0px 2px color-mix(in srgb, var(--affine-primary-color) 30%, transparent);
    }
  ...
  _clickLeft = (e: MouseEvent) => {
    ...
    const i18n = this.view.serviceGet(I18nStringProvider);
      ...
      options: {
        ...
        items: [
          ...
          menu.group({
            items: [
              menu.action({
                name: t('com.affine.data-view.property-menu.move-up', 'Move Up'),
                prefix: html` <div
              ...
              menu.action({
                name: t('com.affine.data-view.property-menu.move-down', 'Move Down'),
                prefix: html` <div
                  style="transform: rotate(90deg);display:flex;align-items:center;"
                >
                  ${MoveRightIcon()}
  ...
  override render() {
    ...
    return html`
      ...
      <div @click="${this._click}" class="${contentClass}" data-empty-text="${this.view.serviceGet(I18nStringProvider)?.t('com.affine.database.empty') || 'Empty'}">
