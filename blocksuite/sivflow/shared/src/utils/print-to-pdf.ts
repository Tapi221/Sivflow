  ...
  return new Promise<void>((resolve, reject) => {
    ...
    iframe.onload = async () => {
      ...
      doc.write(`<!DOCTYPE html><html><head><style>@media print {
                ...
                :root, body {
                  --sivflow-text-primary: #000 !important;
                  --sivflow-text-secondary: #111 !important;
                  --sivflow-text-tertiary: #333 !important;
                  --sivflow-background-primary: #fff !important;
                  --sivflow-background-secondary: #fff !important;
                  --sivflow-background-tertiary: #fff !important;
                }
                ...
                :root {
                  --sivflow-note-shadow-box: none !important;
                  --sivflow-note-shadow-sticker: none !important;
                }
      ...
      iframe.contentWindow.document
        .write(`<!DOCTYPE html><html><head><style>@media print {
              ...
              :root, body {
                ...
                --sivflow-background-secondary: #fff !important;
                --sivflow-background-tertiary: #fff !important;
                --sivflow-background-code-block: #f5f5f5 !important;
                --sivflow-quote-color: #e3e3e3 !important;
                --sivflow-border-color: #e3e3e3 !important;
              }
              body, [data-theme='dark'] {
                color: #000 !important;
                background: #fff !important;
