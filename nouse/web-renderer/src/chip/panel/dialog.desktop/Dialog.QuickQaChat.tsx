...
import { MessageSquare, Plus, Sparkles } from "@web-renderer/chip/icons";
...
const LoadingStatusPill = ({ label }: LoadingStatusPillProps) => {
  return (
    <div className="flex justify-start">
      <div className="inline-flex items-center gap-2 rounded-2xl border border-[#eceae4] bg-white px-3 py-2 text-xs text-[#8a857f] shadow-sm">
        ...
        <div className="border-b border-[#eceae4] px-5 py-4">
          <div className="flex items-center gap-2">
            ...
            <div className="min-w-0">
              <p className="text-sm font-semibold tracking-tight text-[#343434]">Q&Aチャット</p>
              <p className="mt-0.5 text-xs text-[#8a857f]">OllamaのローカルAI回答案を使えます。</p>
            </div>
          </div>
        </div>
        <div className="max-h-96 min-h-64 overflow-y-auto px-5 py-4">
